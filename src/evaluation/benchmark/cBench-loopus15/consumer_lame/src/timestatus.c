...
FLOAT ts_process_time(long frame)
{
    ...
    return (FLOAT) (current_time - initial_time) / 1000000l;
}
...
void timestatus(int samp_rate, long frameNum, long totalframes, int framesize)
{
    ...
    fprintf(stderr, "\r%6ld/%6ld(%3d%%)|%2d:%02d:%02d/%2d:%02d:%02d|%2d:%02d:%02d/%2d:%02d:%02d|%10.4f|%2d:%02d:%02d ", frameNum, totalframes - 1, percent, (int) ((long) (process_time.so_far + .5) / 3600), (int) ((long) ((process_time.so_far + .5) / 60) % 60), (int) ((long) (process_time.so_far + .5) % 60), (int) ((long) (process_time.estimated + .5) / 3600), (int) ((long) ((process_time.estimated + .5) / 60) % 60), (int) ((long) (process_time.estimated + .5) % 60), (int) ((long) (real_time.so_far + .5) / 3600), (int) ((long) ((real_time.so_far + .5) / 60) % 60), (int) ((long) (real_time.so_far + .5) % 60), (int) ((long) (real_time.estimated + .5) / 3600), (int) ((long) ((real_time.estimated + .5) / 60) % 60), (int) ((long) (real_time.estimated + .5) % 60), process_time.speed, (int) ((long) (real_time.eta + .5) / 3600), (int) ((long) ((real_time.eta + .5) / 60) % 60), (int) ((long) (real_time.eta + .5) % 60));
    fflush(stderr);
}
