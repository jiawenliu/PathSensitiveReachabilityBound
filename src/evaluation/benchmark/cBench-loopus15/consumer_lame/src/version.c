...
{
    if (0 > 0)
	sprintf(lpszVersion, "%d.%02d (alpha %d)", 3, 70, 0);
    else if (0 > 0)
	sprintf(lpszVersion, "%d.%02d (beta %d)", 3, 70, 0);
    else
	sprintf(lpszVersion, "%d.%02d", 3, 70);
    return lpszVersion;
}
...
{
    if (0 > 0)
	sprintf(lpszVersion, "%d.%02d (alpha %d)", 0, 77, 0);
    else if (0 > 0)
	sprintf(lpszVersion, "%d.%02d (beta %d)", 0, 77, 0);
    else
	sprintf(lpszVersion, "%d.%02d", 0, 77);
    return lpszVersion;
}
...
{
    if (0 > 0)
	sprintf(lpszVersion, "%d:%02d (alpha %d)", 0, 82, 0);
    else if (0 > 0)
	sprintf(lpszVersion, "%d:%02d (beta %d)", 0, 82, 0);
    else
	sprintf(lpszVersion, "%d:%02d", 0, 82);
    return lpszVersion;
}
