...
void make_decode_tables(long scaleval)
{
	...
	costab = pnts[i];
	for (k = 0; k < kr; k++)
	    costab[k] = 1.0 / (2.0 * cos(3.14159265358979323846 * ((double) k * 2.0 + 1.0) / (double) divv));
    } table = decwin;
    scaleval = -scaleval;
