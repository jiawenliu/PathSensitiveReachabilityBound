...
static int ResvSize = 0;
static int ResvMax = 0;
int ResvFrameBegin(lame_global_flags * gfp, III_side_info_t * l3_side, int mean_bits, int frameLength)
{
    ...
    (((l3_side->main_data_begin * 8) == ResvSize) ? (void) (0) : __assert_fail("(l3_side->main_data_begin * 8) == ResvSize", "reservoir.c", 68, __PRETTY_FUNCTION__));
