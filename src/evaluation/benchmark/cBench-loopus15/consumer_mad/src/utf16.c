...
id3_length_t id3_utf16_length(id3_utf16_t const *utf16)
{
	...
	if (utf16[0] < 0xd800 || utf16[0] > 0xdfff)
	    ++length;
	else if (utf16[0] >= 0xd800 && utf16[0] <= 0xdbff && utf16[1] >= 0xdc00 && utf16[1] <= 0xdfff) {
	    ++length;
	    ++utf16;
	}
	++utf16;
...
id3_length_t id3_utf16_decodechar(id3_utf16_t const *utf16, id3_ucs4_t * ucs4)
{
	...
	if (utf16[0] < 0xd800 || utf16[0] > 0xdfff) {
	    ...
	    *ucs4 = (((utf16[0] & 0x03ffL) << 10) | ((utf16[1] & 0x03ffL) << 0)) + 0x00010000L;
...
id3_length_t id3_utf16_encodechar(id3_utf16_t * utf16, id3_ucs4_t ucs4)
{
    ...
    return id3_utf16_encodechar(utf16, 0x000000b7L);
}
...
id3_length_t id3_utf16_serialize(id3_byte_t ** ptr, id3_ucs4_t const *ucs4, enum id3_utf16_byteorder byteorder, int terminate)
{
    id3_length_t size = 0;
...
id3_ucs4_t *id3_utf16_deserialize(id3_byte_t const **ptr, id3_length_t length, enum id3_utf16_byteorder byteorder)
{
