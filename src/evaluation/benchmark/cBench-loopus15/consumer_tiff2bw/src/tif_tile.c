...
ttile_t TIFFComputeTile(TIFF * tif, uint32 x, uint32 y, uint32 z, tsample_t s)
{
	...
	dz = td->td_imagedepth;
    if (dx != 0 && dy != 0 && dz != 0) {
	uint32 xpt = ((((uint32) (td->td_imagewidth)) + (((uint32) (dx)) - 1)) / ((uint32) (dx)));
	uint32 ypt = ((((uint32) (td->td_imagelength)) + (((uint32) (dy)) - 1)) / ((uint32) (dy)));
	uint32 zpt = ((((uint32) (td->td_imagedepth)) + (((uint32) (dz)) - 1)) / ((uint32) (dz)));
...
int TIFFCheckTile(TIFF * tif, uint32 x, uint32 y, uint32 z, tsample_t s)
{
	...
	TIFFError(tif->tif_name, "Col %ld out of range, max %lu", (long) x, (u_long) td->td_imagewidth);
	return (0);
    }
    if (y >= td->td_imagelength) {
	TIFFError(tif->tif_name, "Row %ld out of range, max %lu", (long) y, (u_long) td->td_imagelength);
	return (0);
    }
    if (z >= td->td_imagedepth) {
	TIFFError(tif->tif_name, "Depth %ld out of range, max %lu", (long) z, (u_long) td->td_imagedepth);
	return (0);
    }
    if (td->td_planarconfig == 2 && s >= td->td_samplesperpixel) {
	TIFFError(tif->tif_name, "Sample %d out of range, max %u", (int) s, td->td_samplesperpixel);
	return (0);
    }
    return (1);
}
...
ttile_t TIFFNumberOfTiles(TIFF * tif)
{
    ...
    if (dz == (uint32) - 1)
	dz = td->td_imagedepth;
    ntiles = (dx == 0 || dy == 0 || dz == 0) ? 0 : (((((uint32) (td->td_imagewidth)) + (((uint32) (dx)) - 1)) / ((uint32) (dx))) * ((((uint32) (td->td_imagelength)) + (((uint32) (dy)) - 1)) / ((uint32) (dy))) * ((((uint32) (td->td_imagedepth)) + (((uint32) (dz)) - 1)) / ((uint32) (dz))));
    if (td->td_planarconfig == 2)
...
tsize_t TIFFTileRowSize(TIFF * tif)
{
    ...
    return ((tsize_t) ((((uint32) (rowsize)) + (((uint32) (8)) - 1)) / ((uint32) (8))));
}
...
tsize_t TIFFVTileSize(TIFF * tif, uint32 nrows)
{
	...
	return ((tsize_t) 0);
    if (td->td_planarconfig == 1 && td->td_photometric == 6 && !(((tif)->tif_flags & 0x4000) != 0)) {
	tsize_t w = (((((uint32) (td->td_tilewidth)) + (((uint32) (td->td_ycbcrsubsampling[0])) - 1)) / ((uint32) (td->td_ycbcrsubsampling[0]))) * ((uint32) (td->td_ycbcrsubsampling[0])));
	tsize_t rowsize = ((((uint32) (w * td->td_bitspersample)) + (((uint32) (8)) - 1)) / ((uint32) (8)));
	tsize_t samplingarea = td->td_ycbcrsubsampling[0] * td->td_ycbcrsubsampling[1];
	nrows = (((((uint32) (nrows)) + (((uint32) (td->td_ycbcrsubsampling[1])) - 1)) / ((uint32) (td->td_ycbcrsubsampling[1]))) * ((uint32) (td->td_ycbcrsubsampling[1])));
...
} void _TIFFDefaultTileSize(TIFF * tif, uint32 * tw, uint32 * th)
{
	...
	*th = 256;
    if (*tw & 0xf)
	*tw = (((((uint32) (*tw)) + (((uint32) (16)) - 1)) / ((uint32) (16))) * ((uint32) (16)));
    if (*th & 0xf)
	*th = (((((uint32) (*th)) + (((uint32) (16)) - 1)) / ((uint32) (16))) * ((uint32) (16)));
}
