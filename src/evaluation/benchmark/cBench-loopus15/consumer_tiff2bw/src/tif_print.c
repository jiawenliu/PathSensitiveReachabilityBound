...
static const char *photoNames[] = { "min-is-white", "min-is-black", "RGB color", "palette color (RGB from colormap)", "transparency mask", "separated", "YCbCr", "7 (0x7)", "CIE L*a*b*", };
static const char *orientNames[] = { "0 (0x0)", "row 0 top, col 0 lhs", "row 0 top, col 0 rhs", "row 0 bottom, col 0 rhs", "row 0 bottom, col 0 lhs", "row 0 lhs, col 0 top", "row 0 rhs, col 0 top", "row 0 rhs, col 0 bottom", "row 0 lhs, col 0 bottom", };
...
void TIFFPrintDirectory(TIFF * tif, FILE * fd, long flags)
{
    ...
    td = &tif->tif_dir;
    if ((((tif)->tif_dir.td_fieldsset[(5) / 32]) & (((u_long) 1L) << ((5) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(1) / 32]) & (((u_long) 1L) << ((1) & 0x1f)))) {
	fprintf(fd, "  Image Width: %lu Image Length: %lu", (u_long) td->td_imagewidth, (u_long) td->td_imagelength);
	if ((((tif)->tif_dir.td_fieldsset[(35) / 32]) & (((u_long) 1L) << ((35) & 0x1f))))
	    fprintf(fd, " Image Depth: %lu", (u_long) td->td_imagedepth);
	fprintf(fd, "\n");
    }
    if ((((tif)->tif_dir.td_fieldsset[(55) / 32]) & (((u_long) 1L) << ((55) & 0x1f))) || (((tif)->tif_dir.td_fieldsset[(56) / 32]) & (((u_long) 1L) << ((56) & 0x1f)))) {
	fprintf(fd, "  Pixar Full Image Width: %lu Full Image Length: %lu\n", (u_long) td->td_imagefullwidth, (u_long) td->td_imagefulllength);
    }
    if ((((tif)->tif_dir.td_fieldsset[(57) / 32]) & (((u_long) 1L) << ((57) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Texture Format", td->td_textureformat);
    if ((((tif)->tif_dir.td_fieldsset[(58) / 32]) & (((u_long) 1L) << ((58) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Texture Wrap Modes", td->td_wrapmodes);
    if ((((tif)->tif_dir.td_fieldsset[(59) / 32]) & (((u_long) 1L) << ((59) & 0x1f))))
	fprintf(fd, "  Field of View Cotangent: %g\n", td->td_fovcot);
    if ((((tif)->tif_dir.td_fieldsset[(60) / 32]) & (((u_long) 1L) << ((60) & 0x1f)))) {
	typedef float Matrix[4][4];
	Matrix *m = (Matrix *) td->td_matrixWorldToScreen;
	fprintf(fd, "  Matrix NP:\n\t%g %g %g %g\n\t%g %g %g %g\n\t%g %g %g %g\n\t%g %g %g %g\n", (*m)[0][0], (*m)[0][1], (*m)[0][2], (*m)[0][3], (*m)[1][0], (*m)[1][1], (*m)[1][2], (*m)[1][3], (*m)[2][0], (*m)[2][1], (*m)[2][2], (*m)[2][3], (*m)[3][0], (*m)[3][1], (*m)[3][2], (*m)[3][3]);
    }
    if ((((tif)->tif_dir.td_fieldsset[(61) / 32]) & (((u_long) 1L) << ((61) & 0x1f)))) {
	typedef float Matrix[4][4];
	Matrix *m = (Matrix *) td->td_matrixWorldToCamera;
	fprintf(fd, "  Matrix Nl:\n\t%g %g %g %g\n\t%g %g %g %g\n\t%g %g %g %g\n\t%g %g %g %g\n", (*m)[0][0], (*m)[0][1], (*m)[0][2], (*m)[0][3], (*m)[1][0], (*m)[1][1], (*m)[1][2], (*m)[1][3], (*m)[2][0], (*m)[2][1], (*m)[2][2], (*m)[2][3], (*m)[3][0], (*m)[3][1], (*m)[3][2], (*m)[3][3]);
    }
    if ((((tif)->tif_dir.td_fieldsset[(2) / 32]) & (((u_long) 1L) << ((2) & 0x1f)))) {
	fprintf(fd, "  Tile Width: %lu Tile Length: %lu", (u_long) td->td_tilewidth, (u_long) td->td_tilelength);
	if ((((tif)->tif_dir.td_fieldsset[(36) / 32]) & (((u_long) 1L) << ((36) & 0x1f))))
	    fprintf(fd, " Tile Depth: %lu", (u_long) td->td_tiledepth);
	fprintf(fd, "\n");
    }
    if ((((tif)->tif_dir.td_fieldsset[(3) / 32]) & (((u_long) 1L) << ((3) & 0x1f)))) {
	fprintf(fd, "  Resolution: %g, %g", td->td_xresolution, td->td_yresolution);
	if ((((tif)->tif_dir.td_fieldsset[(22) / 32]) & (((u_long) 1L) << ((22) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(4) / 32]) & (((u_long) 1L) << ((4) & 0x1f))))
	fprintf(fd, "  Position: %g, %g\n", td->td_xposition, td->td_yposition);
    if ((((tif)->tif_dir.td_fieldsset[(6) / 32]) & (((u_long) 1L) << ((6) & 0x1f))))
	fprintf(fd, "  Bits/Sample: %u\n", td->td_bitspersample);
    if ((((tif)->tif_dir.td_fieldsset[(32) / 32]) & (((u_long) 1L) << ((32) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(8) / 32]) & (((u_long) 1L) << ((8) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(31) / 32]) & (((u_long) 1L) << ((31) & 0x1f))) && td->td_extrasamples) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(54) / 32]) & (((u_long) 1L) << ((54) & 0x1f)))) {
	fprintf(fd, "  Sample to Nits conversion factor: %.4e\n", td->td_stonits);
    }
    if ((((tif)->tif_dir.td_fieldsset[(45) / 32]) & (((u_long) 1L) << ((45) & 0x1f)))) {
	fprintf(fd, "  Ink Set: ");
	switch (td->td_inkset) {
	case 1:
	    fprintf(fd, "CMYK\n");
    ...
    if ((((tif)->tif_dir.td_fieldsset[(46) / 32]) & (((u_long) 1L) << ((46) & 0x1f)))) {
	char *cp;
    ...
    if ((((tif)->tif_dir.td_fieldsset[(50) / 32]) & (((u_long) 1L) << ((50) & 0x1f))))
	fprintf(fd, " Number of Inks: %u\n", td->td_ninks);
    if ((((tif)->tif_dir.td_fieldsset[(47) / 32]) & (((u_long) 1L) << ((47) & 0x1f))))
	fprintf(fd, "  Dot Range: %u-%u\n", td->td_dotrange[0], td->td_dotrange[1]);
    if ((((tif)->tif_dir.td_fieldsset[(48) / 32]) & (((u_long) 1L) << ((48) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Target Printer", td->td_targetprinter);
    if ((((tif)->tif_dir.td_fieldsset[(9) / 32]) & (((u_long) 1L) << ((9) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(10) / 32]) & (((u_long) 1L) << ((10) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(39) / 32]) & (((u_long) 1L) << ((39) & 0x1f))))
	fprintf(fd, "  YCbCr Subsampling: %u, %u\n", td->td_ycbcrsubsampling[0], td->td_ycbcrsubsampling[1]);
    if ((((tif)->tif_dir.td_fieldsset[(40) / 32]) & (((u_long) 1L) << ((40) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(38) / 32]) & (((u_long) 1L) << ((38) & 0x1f))))
	fprintf(fd, "  YCbCr Coefficients: %g, %g, %g\n", td->td_ycbcrcoeffs[0], td->td_ycbcrcoeffs[1], td->td_ycbcrcoeffs[2]);
    if ((((tif)->tif_dir.td_fieldsset[(37) / 32]) & (((u_long) 1L) << ((37) & 0x1f))))
	fprintf(fd, "  Halftone Hints: light %u dark %u\n", td->td_halftonehints[0], td->td_halftonehints[1]);
    if ((((tif)->tif_dir.td_fieldsset[(27) / 32]) & (((u_long) 1L) << ((27) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Artist", td->td_artist);
    if ((((tif)->tif_dir.td_fieldsset[(28) / 32]) & (((u_long) 1L) << ((28) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Date & Time", td->td_datetime);
    if ((((tif)->tif_dir.td_fieldsset[(29) / 32]) & (((u_long) 1L) << ((29) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Host Computer", td->td_hostcomputer);
    if ((((tif)->tif_dir.td_fieldsset[(30) / 32]) & (((u_long) 1L) << ((30) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Software", td->td_software);
    if ((((tif)->tif_dir.td_fieldsset[(11) / 32]) & (((u_long) 1L) << ((11) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Document Name", td->td_documentname);
    if ((((tif)->tif_dir.td_fieldsset[(12) / 32]) & (((u_long) 1L) << ((12) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Image Description", td->td_imagedescription);
    if ((((tif)->tif_dir.td_fieldsset[(13) / 32]) & (((u_long) 1L) << ((13) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Make", td->td_make);
    if ((((tif)->tif_dir.td_fieldsset[(14) / 32]) & (((u_long) 1L) << ((14) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Model", td->td_model);
    if ((((tif)->tif_dir.td_fieldsset[(15) / 32]) & (((u_long) 1L) << ((15) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(16) / 32]) & (((u_long) 1L) << ((16) & 0x1f))))
	fprintf(fd, "  Samples/Pixel: %u\n", td->td_samplesperpixel);
    if ((((tif)->tif_dir.td_fieldsset[(17) / 32]) & (((u_long) 1L) << ((17) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(18) / 32]) & (((u_long) 1L) << ((18) & 0x1f))))
	fprintf(fd, "  Min Sample Value: %u\n", td->td_minsamplevalue);
    if ((((tif)->tif_dir.td_fieldsset[(19) / 32]) & (((u_long) 1L) << ((19) & 0x1f))))
	fprintf(fd, "  Max Sample Value: %u\n", td->td_maxsamplevalue);
    if ((((tif)->tif_dir.td_fieldsset[(33) / 32]) & (((u_long) 1L) << ((33) & 0x1f))))
	fprintf(fd, "  SMin Sample Value: %g\n", td->td_sminsamplevalue);
    if ((((tif)->tif_dir.td_fieldsset[(34) / 32]) & (((u_long) 1L) << ((34) & 0x1f))))
	fprintf(fd, "  SMax Sample Value: %g\n", td->td_smaxsamplevalue);
    if ((((tif)->tif_dir.td_fieldsset[(20) / 32]) & (((u_long) 1L) << ((20) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(21) / 32]) & (((u_long) 1L) << ((21) & 0x1f))))
	_TIFFprintAsciiTag(fd, "Page Name", td->td_pagename);
    if ((((tif)->tif_dir.td_fieldsset[(23) / 32]) & (((u_long) 1L) << ((23) & 0x1f))))
	fprintf(fd, "  Page Number: %u-%u\n", td->td_pagenumber[0], td->td_pagenumber[1]);
    if ((((tif)->tif_dir.td_fieldsset[(26) / 32]) & (((u_long) 1L) << ((26) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(42) / 32]) & (((u_long) 1L) << ((42) & 0x1f))))
	fprintf(fd, "  White Point: %g-%g\n", td->td_whitepoint[0], td->td_whitepoint[1]);
    if ((((tif)->tif_dir.td_fieldsset[(43) / 32]) & (((u_long) 1L) << ((43) & 0x1f))))
	fprintf(fd, "  Primary Chromaticities: %g,%g %g,%g %g,%g\n", td->td_primarychromas[0], td->td_primarychromas[1], td->td_primarychromas[2], td->td_primarychromas[3], td->td_primarychromas[4], td->td_primarychromas[5]);
    if ((((tif)->tif_dir.td_fieldsset[(41) / 32]) & (((u_long) 1L) << ((41) & 0x1f)))) {
	fprintf(fd, "  Reference Black/White:\n");
	for (i = 0; i < td->td_samplesperpixel; i++)
	    fprintf(fd, "    %2d: %5g %5g\n", i, td->td_refblackwhite[2 * i + 0], td->td_refblackwhite[2 * i + 1]);
    }
    if ((((tif)->tif_dir.td_fieldsset[(44) / 32]) & (((u_long) 1L) << ((44) & 0x1f)))) {
    ...
    if ((((tif)->tif_dir.td_fieldsset[(51) / 32]) & (((u_long) 1L) << ((51) & 0x1f))))
	fprintf(fd, "  ICC Profile: <present>, %lu bytes\n", (u_long) td->td_profileLength);
    if ((((tif)->tif_dir.td_fieldsset[(52) / 32]) & (((u_long) 1L) << ((52) & 0x1f))))
	fprintf(fd, "  Photoshop Data: <present>, %lu bytes\n", (u_long) td->td_photoshopLength);
    if ((((tif)->tif_dir.td_fieldsset[(53) / 32]) & (((u_long) 1L) << ((53) & 0x1f))))
	fprintf(fd, "  RichTIFFIPTC Data: <present>, %lu bytes\n", (u_long) td->td_richtiffiptcLength);
    if ((((tif)->tif_dir.td_fieldsset[(49) / 32]) & (((u_long) 1L) << ((49) & 0x1f)))) {
    ...
    if ((flags & 0x1) && (((tif)->tif_dir.td_fieldsset[(25) / 32]) & (((u_long) 1L) << ((25) & 0x1f)))) {
	tstrip_t s;
	fprintf(fd, "  %lu %s:\n", (long) td->td_nstrips, (((tif)->tif_flags & 0x0400) != 0) ? "Tiles" : "Strips");
	for (s = 0; s < td->td_nstrips; s++)
	    fprintf(fd, "    %3lu: [%8lu, %8lu]\n", (u_long) s, (u_long) td->td_stripoffset[s], (u_long) td->td_stripbytecount[s]);
    }
}
