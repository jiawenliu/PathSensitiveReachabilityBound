...
static const TIFFFieldInfo tiffFieldInfo[] = { {254, 1, 1, TIFF_LONG, 5, 1, 0, "SubfileType"}, {254, 1, 1, TIFF_SHORT, 5, 1, 0, "SubfileType"}, {255, 1, 1, TIFF_SHORT, 5, 1, 0, "OldSubfileType"}, {256, 1, 1, TIFF_LONG, 1, 0, 0, "ImageWidth"}, {256, 1, 1, TIFF_SHORT, 1, 0, 0, "ImageWidth"}, {257, 1, 1, TIFF_LONG, 1, 1, 0, "ImageLength"}, {257, 1, 1, TIFF_SHORT, 1, 1, 0, "ImageLength"}, {258, -1, -1, TIFF_SHORT, 6, 0, 0, "BitsPerSample"}, {259, -1, 1, TIFF_SHORT, 7, 0, 0, "Compression"}, {262, 1, 1, TIFF_SHORT, 8, 0, 0, "PhotometricInterpretation"}, {263, 1, 1, TIFF_SHORT, 9, 1, 0, "Threshholding"}, {264, 1, 1, TIFF_SHORT, 0, 1, 0, "CellWidth"}, {265, 1, 1, TIFF_SHORT, 0, 1, 0, "CellLength"}, {266, 1, 1, TIFF_SHORT, 10, 0, 0, "FillOrder"}, {269, -1, -1, TIFF_ASCII, 11, 1, 0, "DocumentName"}, {270, -1, -1, TIFF_ASCII, 12, 1, 0, "ImageDescription"}, {271, -1, -1, TIFF_ASCII, 13, 1, 0, "Make"}, {272, -1, -1, TIFF_ASCII, 14, 1, 0, "Model"}, {273, -1, -1, TIFF_LONG, 25, 0, 0, "StripOffsets"}, {273, -1, -1, TIFF_SHORT, 25, 0, 0, "StripOffsets"}, {274, 1, 1, TIFF_SHORT, 15, 0, 0, "Orientation"}, {277, 1, 1, TIFF_SHORT, 16, 0, 0, "SamplesPerPixel"}, {278, 1, 1, TIFF_LONG, 17, 0, 0, "RowsPerStrip"}, {278, 1, 1, TIFF_SHORT, 17, 0, 0, "RowsPerStrip"}, {279, -1, -1, TIFF_LONG, 24, 0, 0, "StripByteCounts"}, {279, -1, -1, TIFF_SHORT, 24, 0, 0, "StripByteCounts"}, {280, -2, -1, TIFF_SHORT, 18, 1, 0, "MinSampleValue"}, {281, -2, -1, TIFF_SHORT, 19, 1, 0, "MaxSampleValue"}, {282, 1, 1, TIFF_RATIONAL, 3, 0, 0, "XResolution"}, {283, 1, 1, TIFF_RATIONAL, 3, 0, 0, "YResolution"}, {284, 1, 1, TIFF_SHORT, 20, 0, 0, "PlanarConfiguration"}, {285, -1, -1, TIFF_ASCII, 21, 1, 0, "PageName"}, {286, 1, 1, TIFF_RATIONAL, 4, 1, 0, "XPosition"}, {287, 1, 1, TIFF_RATIONAL, 4, 1, 0, "YPosition"}, {288, -1, -1, TIFF_LONG, 0, 0, 0, "FreeOffsets"}, {289, -1, -1, TIFF_LONG, 0, 0, 0, "FreeByteCounts"}, {290, 1, 1, TIFF_SHORT, 0, 1, 0, "GrayResponseUnit"}, {291, -1, -1, TIFF_SHORT, 0, 1, 0, "GrayResponseCurve"}, {296, 1, 1, TIFF_SHORT, 22, 0, 0, "ResolutionUnit"}, {297, 2, 2, TIFF_SHORT, 23, 1, 0, "PageNumber"}, {300, 1, 1, TIFF_SHORT, 0, 1, 0, "ColorResponseUnit"}, {301, -1, -1, TIFF_SHORT, 44, 1, 0, "TransferFunction"}, {305, -1, -1, TIFF_ASCII, 30, 1, 0, "Software"}, {306, 20, 20, TIFF_ASCII, 28, 1, 0, "DateTime"}, {315, -1, -1, TIFF_ASCII, 27, 1, 0, "Artist"}, {316, -1, -1, TIFF_ASCII, 29, 1, 0, "HostComputer"}, {318, 2, 2, TIFF_RATIONAL, 42, 1, 0, "WhitePoint"}, {319, 6, 6, TIFF_RATIONAL, 43, 1, 0, "PrimaryChromaticities"}, {320, -1, -1, TIFF_SHORT, 26, 1, 0, "ColorMap"}, {321, 2, 2, TIFF_SHORT, 37, 1, 0, "HalftoneHints"}, {322, 1, 1, TIFF_LONG, 2, 0, 0, "TileWidth"}, {322, 1, 1, TIFF_SHORT, 2, 0, 0, "TileWidth"}, {323, 1, 1, TIFF_LONG, 2, 0, 0, "TileLength"}, {323, 1, 1, TIFF_SHORT, 2, 0, 0, "TileLength"}, {324, -1, 1, TIFF_LONG, 25, 0, 0, "TileOffsets"}, {325, -1, 1, TIFF_LONG, 24, 0, 0, "TileByteCounts"}, {325, -1, 1, TIFF_SHORT, 24, 0, 0, "TileByteCounts"}, {330, -1, -1, TIFF_LONG, 49, 1, 1, "SubIFD"}, {332, 1, 1, TIFF_SHORT, 45, 0, 0, "InkSet"}, {333, -1, -1, TIFF_ASCII, 46, 1, 1, "InkNames"}, {334, 1, 1, TIFF_SHORT, 50, 1, 0, "NumberOfInks"}, {336, 2, 2, TIFF_SHORT, 47, 0, 0, "DotRange"}, {336, 2, 2, TIFF_BYTE, 47, 0, 0, "DotRange"}, {337, -1, -1, TIFF_ASCII, 48, 1, 0, "TargetPrinter"}, {338, -1, -1, TIFF_SHORT, 31, 0, 0, "ExtraSamples"}, {338, -1, -1, TIFF_BYTE, 31, 0, 0, "ExtraSamples"}, {339, -1, -1, TIFF_SHORT, 32, 0, 0, "SampleFormat"}, {340, -2, -1, TIFF_NOTYPE, 33, 1, 0, "SMinSampleValue"}, {341, -2, -1, TIFF_NOTYPE, 34, 1, 0, "SMaxSampleValue"}, {529, 3, 3, TIFF_RATIONAL, 38, 0, 0, "YCbCrCoefficients"}, {530, 2, 2, TIFF_SHORT, 39, 0, 0, "YCbCrSubsampling"}, {531, 1, 1, TIFF_SHORT, 40, 0, 0, "YCbCrPositioning"}, {532, 6, 6, TIFF_RATIONAL, 41, 1, 0, "ReferenceBlackWhite"}, {532, 6, 6, TIFF_LONG, 41, 1, 0, "ReferenceBlackWhite"}, {32995, 1, 1, TIFF_SHORT, 31, 0, 0, "Matteing"}, {32996, -2, -1, TIFF_SHORT, 32, 0, 0, "DataType"}, {32997, 1, 1, TIFF_LONG, 35, 0, 0, "ImageDepth"}, {32997, 1, 1, TIFF_SHORT, 35, 0, 0, "ImageDepth"}, {32998, 1, 1, TIFF_LONG, 36, 0, 0, "TileDepth"}, {32998, 1, 1, TIFF_SHORT, 36, 0, 0, "TileDepth"}, {33723, -1, -1, TIFF_LONG, 53, 0, 1, "RichTIFFIPTC"}, {34377, -1, -3, TIFF_UNDEFINED, 52, 0, 1, "Photoshop"}, {34377, -1, -1, TIFF_BYTE, 52, 0, 1, "Photoshop"}, {34675, -1, -3, TIFF_UNDEFINED, 51, 0, 1, "ICC Profile"}, {37439, 1, 1, TIFF_DOUBLE, 54, 0, 0, "StoNits"}, {33300, 1, 1, TIFF_LONG, 55, 1, 0, "ImageFullWidth"}, {33301, 1, 1, TIFF_LONG, 56, 1, 0, "ImageFullLength"}, {33302, -1, -1, TIFF_ASCII, 57, 1, 0, "TextureFormat"}, {33303, -1, -1, TIFF_ASCII, 58, 1, 0, "TextureWrapModes"}, {33304, 1, 1, TIFF_FLOAT, 59, 1, 0, "FieldOfViewCotan"}, {33305, 16, 16, TIFF_FLOAT, 60, 1, 0, "MatrixWorldToScreen"}, {33306, 16, 16, TIFF_FLOAT, 61, 1, 0, "MatrixWorldToCamera"}, };
...
void _TIFFSetupFieldInfo(TIFF * tif)
{
    ...
    _TIFFMergeFieldInfo(tif, tiffFieldInfo, (sizeof(tiffFieldInfo) / sizeof(tiffFieldInfo[0])));
}
...
void _TIFFMergeFieldInfo(TIFF * tif, const TIFFFieldInfo info[], int n)
{
	...
	tif->tif_fieldinfo = (TIFFFieldInfo **) _TIFFrealloc(tif->tif_fieldinfo, (tif->tif_nfields + n) * sizeof(TIFFFieldInfo *));
    } else {
	tif->tif_fieldinfo = (TIFFFieldInfo **) _TIFFmalloc(n * sizeof(TIFFFieldInfo *));
    }
    tp = &tif->tif_fieldinfo[tif->tif_nfields];
    for (i = 0; i < n; i++)
	tp[i] = (TIFFFieldInfo *) & info[i];
    if (tif->tif_nfields > 0)
	qsort(tif->tif_fieldinfo, (size_t) (tif->tif_nfields += n), sizeof(TIFFFieldInfo *), tagCompare);
    else
	tif->tif_nfields += n;
}
...
void _TIFFPrintFieldInfo(TIFF * tif, FILE * fd)
{
	...
	fprintf(fd, "field[%2d] %5lu, %2d, %2d, %d, %2d, %5s, %5s, %s\n", i, (unsigned long) fip->field_tag, fip->field_readcount, fip->field_writecount, fip->field_type, fip->field_bit, fip->field_oktochange ? "TRUE" : "FALSE", fip->field_passcount ? "TRUE" : "FALSE", fip->field_name);
}} const int tiffDataWidth[] = { 1, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8, };

TIFFDataType _TIFFSampleToTagType(TIFF * tif)
{
    int bps = (int) ((((uint32) (tif->tif_dir.td_bitspersample)) + (((uint32) (8)) - 1)) / ((uint32) (8)));
...
{
    static const TIFFFieldInfo *last = ((void *) 0);
    int i, n;
    if (last && last->field_tag == tag && (dt == TIFF_NOTYPE || dt == last->field_type))
	return (last);
    for (i = 0, n = tif->tif_nfields; i < n; i++) {
	const TIFFFieldInfo *fip = tif->tif_fieldinfo[i];
	if (fip->field_tag == tag && (dt == TIFF_NOTYPE || fip->field_type == dt))
	    return (last = fip);
    }
...
const TIFFFieldInfo *_TIFFFieldWithTag(TIFF * tif, ttag_t tag)
{
    ...
    if (!fip) {
	TIFFError("TIFFFieldWithTag", "Internal error, unknown tag 0x%x", (u_int) tag);
	((fip != ((void *) 0)) ? (void) (0) : __assert_fail("fip != ((void*)0)", "tif_dirinfo.c", 398, __PRETTY_FUNCTION__));
    }
    return (fip);
}
