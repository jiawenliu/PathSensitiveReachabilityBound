...
{
    LZWDecodeState *sp = ((LZWDecodeState *) ((LZWBaseState *) (tif)->tif_data));
    static const char module[] = " LZWSetupDecode";
    int code;
    ((sp != ((void *) 0)) ? (void) (0) : __assert_fail("sp != ((void*)0)", "tif_lzw.c", 196, __PRETTY_FUNCTION__));
    if (sp->dec_codetab == ((void *) 0)) {
	sp->dec_codetab = (code_t *) _TIFFmalloc((((1L << (12)) - 1) + 1024L) * sizeof(code_t));
	if (sp->dec_codetab == ((void *) 0)) {
	...
	for (code = 255; code >= 0; code--) {
	    ...
	    sp->dec_codetab[code].next = ((void *) 0);
    }}
    return (1);
}
...
static int LZWPreDecode(TIFF * tif, tsample_t s)
{
    LZWDecodeState *sp = ((LZWDecodeState *) ((LZWBaseState *) (tif)->tif_data));
    (void) s;
    ((sp != ((void *) 0)) ? (void) (0) : __assert_fail("sp != ((void*)0)", "tif_lzw.c", 225, __PRETTY_FUNCTION__));
	...
	sp->base.maxcode = ((1L << (9)) - 1);
    } else {
	sp->base.maxcode = ((1L << (9)) - 1) - 1;
    ...
    sp->base.nextdata = 0;
    sp->dec_restart = 0;
    sp->dec_nbitsmask = ((1L << (9)) - 1);
    sp->dec_bitsleft = tif->tif_rawcc << 3;
    sp->dec_free_entp = sp->dec_codetab + 258;
    _TIFFmemset(sp->dec_free_entp, 0, ((((1L << (12)) - 1) + 1024L) - 258) * sizeof(code_t));
...
{
    TIFFError(tif->tif_name, "LZWDecode: Bogus encoding, loop in the code table; scanline %d", tif->tif_row);
} static int LZWDecode(TIFF * tif, tidata_t op0, tsize_t occ0, tsample_t s)
{
    ...
    (void) s;
    ((sp != ((void *) 0)) ? (void) (0) : __assert_fail("sp != ((void*)0)", "tif_lzw.c", 324, __PRETTY_FUNCTION__));
    if (sp->dec_restart) {
	long residue;
	codep = sp->dec_codep;
	...
	((&sp->dec_codetab[0] <= free_entp && free_entp < &sp->dec_codetab[(((1L << (12)) - 1) + 1024L)]) ? (void) (0) : __assert_fail("&sp->dec_codetab[0] <= free_entp && free_entp < &sp->dec_codetab[(((1L<<(12))-1)+1024L)]", "tif_lzw.c", 398, __PRETTY_FUNCTION__));
...
static int LZWDecodeCompat(TIFF * tif, tidata_t op0, tsize_t occ0, tsample_t s)
{
    ...
    code_t *codep, *free_entp, *maxcodep, *oldcodep;
    (void) s;
    ((sp != ((void *) 0)) ? (void) (0) : __assert_fail("sp != ((void*)0)", "tif_lzw.c", 504, __PRETTY_FUNCTION__));
    if (sp->dec_restart) {
	long residue;
	codep = sp->dec_codep;
	residue = codep->length - sp->dec_restart;
	...
	codep = sp->dec_codetab + code;
	((&sp->dec_codetab[0] <= free_entp && free_entp < &sp->dec_codetab[(((1L << (12)) - 1) + 1024L)]) ? (void) (0) : __assert_fail("&sp->dec_codetab[0] <= free_entp && free_entp < &sp->dec_codetab[(((1L<<(12))-1)+1024L)]", "tif_lzw.c", 573, __PRETTY_FUNCTION__));
	free_entp->next = oldcodep;
	free_entp->firstchar = free_entp->next->firstchar;
	free_entp->length = free_entp->next->length + 1;
	free_entp->value = (codep < free_entp) ? codep->firstchar : free_entp->firstchar;
    ...
    sp->dec_maxcodep = maxcodep;
    if (occ > 0) {
	TIFFError(tif->tif_name, "LZWDecodeCompat: Not enough data at scanline %d (short %d bytes)", tif->tif_row, occ);
	return (0);
    }
    return (1);
}
...
static void LZWCleanup(TIFF * tif)
{
    if (tif->tif_data) {
	if (tif->tif_mode == 00) {
	    if (((LZWDecodeState *) ((LZWBaseState *) (tif)->tif_data))->dec_codetab)
		_TIFFfree(((LZWDecodeState *) ((LZWBaseState *) (tif)->tif_data))->dec_codetab);
	}
...
{
    ((scheme == 5) ? (void) (0) : __assert_fail("scheme == 5", "tif_lzw.c", 663, __PRETTY_FUNCTION__));
    tif->tif_data = (tidata_t) _TIFFmalloc(sizeof(LZWDecodeState));
    if (tif->tif_data == ((void *) 0))
	goto bad;
    if (tif->tif_mode == 00) {
	((LZWDecodeState *) ((LZWBaseState *) (tif)->tif_data))->dec_codetab = ((void *) 0);
	((LZWDecodeState *) ((LZWBaseState *) (tif)->tif_data))->dec_decode = ((void *) 0);
    }
    ...
    return (1);
  bad:TIFFError("TIFFInitLZW", "No space for LZW state block");
    return (0);
}
