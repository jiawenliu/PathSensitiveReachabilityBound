...
int main1(int argc, char *argv[])
{
    ...
    if (out == ((void *) 0))
	return (-1);
    if (TIFFGetField(in, 256, &imagewidth))
	TIFFSetField(out, 256, imagewidth);
