...
int encrypt;
{
	...
	l ^= p[0];
	r ^= p[1];
	r ^= (((s[(l >> 24L)] + s[0x0100 + ((l >> 16L) & 0xff)]) ^ s[0x0200 + ((l >> 8L) & 0xff)]) + s[0x0300 + ((l) & 0xff)]) & 0xffffffff;;
	l ^= p[2];
	l ^= (((s[(r >> 24L)] + s[0x0100 + ((r >> 16L) & 0xff)]) ^ s[0x0200 + ((r >> 8L) & 0xff)]) + s[0x0300 + ((r) & 0xff)]) & 0xffffffff;;
	r ^= p[3];
	r ^= (((s[(l >> 24L)] + s[0x0100 + ((l >> 16L) & 0xff)]) ^ s[0x0200 + ((l >> 8L) & 0xff)]) + s[0x0300 + ((l) & 0xff)]) & 0xffffffff;;
	l ^= p[4];
	l ^= (((s[(r >> 24L)] + s[0x0100 + ((r >> 16L) & 0xff)]) ^ s[0x0200 + ((r >> 8L) & 0xff)]) + s[0x0300 + ((r) & 0xff)]) & 0xffffffff;;
