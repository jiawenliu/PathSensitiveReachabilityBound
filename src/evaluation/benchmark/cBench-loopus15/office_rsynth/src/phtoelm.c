...
enum Eparm_e { fn, f1, f2, f3, b1, b2, b3, an, a1, a2, a3, a4, a5, a6, ab, av, avc, asp, af, nEparm };
...
trie_ptr phtoelm = ((void *) 0);
static Elm_ptr find_elm(char *s);
static Elm_ptr find_elm(s)
char *s;
{
    Elm_ptr e = Elements;
...
} static void enter(char *p, ...)
{
    ...
    while ((s = __builtin_va_arg(ap, char *))) {
...
{
    enter(" ", "Q", ((void *) 0));
    enter("p", "P", "PY", "PZ", ((void *) 0));
    enter("t", "T", "TY", "TZ", ((void *) 0));
    enter("k", "K", "KY", "KZ", ((void *) 0));
    enter("b", "B", "BY", "BZ", ((void *) 0));
    enter("d", "D", "DY", "DZ", ((void *) 0));
    enter("g", "G", "GY", "GZ", ((void *) 0));
    enter("m", "M", ((void *) 0));
    enter("n", "N", ((void *) 0));
    enter("N", "NG", ((void *) 0));
    enter("f", "F", ((void *) 0));
    ...
    enter("S", "SH", ((void *) 0));
    enter("h", "H", ((void *) 0));
    enter("v", "V", "QQ", "V", ((void *) 0));
    enter("D", "DH", "QQ", "DI", ((void *) 0));
    enter("z", "Z", "QQ", "ZZ", ((void *) 0));
    enter("Z", "ZH", "QQ", "ZH", ((void *) 0));
    enter("tS", "CH", "CI", ((void *) 0));
    enter("dZ", "J", "JY", "QQ", "JY", ((void *) 0));
    enter("l", "L", ((void *) 0));
    enter("r", "R", ((void *) 0));
    enter("rr", "R", "QQ", "R", ((void *) 0));
    enter("R", "RX", ((void *) 0));
    enter("w", "W", ((void *) 0));
    enter("x", "X", ((void *) 0));
    enter("%", "QQ", ((void *) 0));
    ...
    enter("u", "UU", ((void *) 0));
    enter("o", "OI", ((void *) 0));
    enter("eI", "AI", "I", ((void *) 0));
    enter("aI", "IE", "I", ((void *) 0));
    enter("oI", "OI", "I", ((void *) 0));
    enter("aU", "OU", "OV", ((void *) 0));
    enter("@U", "OA", "OV", ((void *) 0));
    enter("I@", "IA", "IB", ((void *) 0));
    enter("e@", "AIR", "IB", ((void *) 0));
    enter("U@", "OOR", "IB", ((void *) 0));
    enter("O@", "OR", "IB", ((void *) 0));
    enter("oU", "OI", "OV", ((void *) 0));
} int phone_append(p, ch)
...
unsigned phone_to_elm(phone, n, elm)
char *phone;
int n;
darray_ptr elm;
{
	...
	if (e) {
		...
		phone_append(elm, x);
		if (!(p->feat & 0x10000000))
		    stress = 0;
		t += phone_append(elm, (stress, ((p->du + p->ud) / 2) * speed));
