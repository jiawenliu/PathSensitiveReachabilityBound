...
static int mem_true32_copy_mono(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height, gx_color_index color0, gx_color_index color1);
static int mem_true32_copy_color(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height);
static int mem_true32_fill_rectangle(gx_device * dev, int x, int y, int width, int height, gx_color_index color);
const gx_device_memory mem_true32_device = { sizeof(gx_device_memory), 0, "image32", 0, 0, 0, 0, {(24 ? 3 : 0) + (8 ? 1 : 0), 24 + 8, (8 ? (1 << 8) - 1 : (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 0) - 1)), (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 8) - 1), (8 ? (1 << 8) - 1 : (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 0) - 1)) + 1, (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 8) - 1) + 1}
...
, {mem_open, mem_get_initial_matrix, gx_default_sync_output, gx_default_output_page, mem_close, gx_default_w_b_map_rgb_color, gx_default_w_b_map_color_rgb, mem_true32_fill_rectangle, gx_default_tile_rectangle, mem_true32_copy_mono, mem_true32_copy_color, gx_default_draw_line, mem_get_bits, gx_default_get_params, gx_default_put_params, gx_default_cmyk_map_cmyk_color, gx_forward_get_xfont_procs, gx_forward_get_xfont_device, gx_default_map_rgb_alpha_color, gx_forward_get_page_device, gx_default_get_alpha_bits, gx_default_copy_alpha, gx_default_get_band, gx_default_copy_rop, gx_default_fill_path, gx_default_stroke_path, gx_default_fill_mask, gx_default_fill_trapezoid, gx_default_fill_parallelogram, gx_default_fill_triangle, gx_default_draw_thin_line, gx_default_begin_image, gx_default_image_data, gx_default_end_image, gx_default_strip_tile_rectangle, gx_no_strip_copy_rop, gx_default_get_clipping_box}
...
static int mem_true32_fill_rectangle(gx_device * dev, int x, int y, int w, int h, gx_color_index color)
{
    bits32 a_color;
    register byte *dest;
    uint draster;
    ...
    if (w <= 0 || h <= 0)
	return 0;
    a_color = (((color) >> 24) + (((color) >> 8) & 0xff00) + (((color) & 0xff00) << 8) + ((color) << 24));
    draster = ((gx_device_memory *) dev)->raster;
    dest = (byte *) (((((gx_device_memory *) dev))->line_ptrs[y]) + (((x) << 2) & -(sizeof(byte) == 1 ? 1 : sizeof(byte) == sizeof(short) ? 2 : sizeof(byte) == sizeof(int) ? 4 : 4)));
    if (w <= 4)
	switch (w) {
	case 1:
	    do {
...
static int mem_true32_copy_mono(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h, gx_color_index zero, gx_color_index one)
{
    bits32 a_zero = (((zero) >> 24) + (((zero) >> 8) & 0xff00) + (((zero) & 0xff00) << 8) + ((zero) << 24));
    bits32 a_one = (((one) >> 24) + (((one) >> 8) & 0xff00) + (((one) & 0xff00) << 8) + ((one) << 24));
    const byte *line;
    int first_bit;
    register byte *dest;
    uint draster;
...
static int mem_true32_copy_color(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h)
{
    if ((x | y) < 0) {
	if (x < 0)
	    w += x, sourcex -= x, x = 0;
    ...
    if (w <= 0 || h <= 0)
	return 0;
    bytes_copy_rectangle(((((gx_device_memory *) dev))->line_ptrs[y]) + ((x) << 2), (((gx_device_memory *) dev))->raster, base + ((sourcex) << 2), sraster, ((w) << 2), h);
    return 0;
}

static int mem32_word_copy_mono(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height, gx_color_index color0, gx_color_index color1);
static int mem32_word_copy_color(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height);
static int mem32_word_fill_rectangle(gx_device * dev, int x, int y, int width, int height, gx_color_index color);
const gx_device_memory mem_true32_word_device = { sizeof(gx_device_memory), 0, "image32w", 0, 0, 0, 0, {(24 ? 3 : 0) + (8 ? 1 : 0), 24 + 8, (8 ? (1 << 8) - 1 : (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 0) - 1)), (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 8) - 1), (8 ? (1 << 8) - 1 : (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 0) - 1)) + 1, (24 >= 8 ? 255 : 24 == 4 ? 15 : 24 == 2 ? 3 : 24 == 1 ? 1 : (1 << 8) - 1) + 1}
, 0, 0, {(((0) * 72.0 + 0.5) - 0.5) / (72), (((0) * 72.0 + 0.5) - 0.5) / (72)}
, {0, 0, 0, 0}
, 0, {72, 72}
, {72, 72}
...
, {0, 0, 0, 0}
, 0, 0, 0, {gx_default_install, gx_default_begin_page, gx_default_end_page}
, {mem_open, mem_get_initial_matrix, gx_default_sync_output, gx_default_output_page, mem_close, gx_default_w_b_map_rgb_color, gx_default_w_b_map_color_rgb, mem32_word_fill_rectangle, gx_default_tile_rectangle, mem32_word_copy_mono, mem32_word_copy_color, gx_default_draw_line, mem_word_get_bits, gx_default_get_params, gx_default_put_params, gx_default_cmyk_map_cmyk_color, gx_forward_get_xfont_procs, gx_forward_get_xfont_device, gx_default_map_rgb_alpha_color, gx_forward_get_page_device, gx_default_get_alpha_bits, gx_default_copy_alpha, gx_default_get_band, gx_default_copy_rop, gx_default_fill_path, gx_default_stroke_path, gx_default_fill_mask, gx_default_fill_trapezoid, gx_default_fill_parallelogram, gx_default_fill_triangle, gx_default_draw_thin_line, gx_default_begin_image, gx_default_image_data, gx_default_end_image, gx_default_strip_tile_rectangle, gx_no_strip_copy_rop, gx_default_get_clipping_box}
, 0, {(float) (1), (float) (0), (float) (0), (float) (1), (float) (0), (float) (0)}, 0, ((bool) 1), (byte *) 0, (byte **) 0, 0, {(byte *) 0, 0}, {((unsigned long) (-1))}, {0, 0}, 0, 0, 0, 0, 0, ((unsigned long) (-1)) };

static int mem32_word_fill_rectangle(gx_device * dev, int x, int y, int w, int h, gx_color_index color)
{
    return mem_true32_fill_rectangle(dev, x, y, w, h, (((color) >> 24) + (((color) >> 8) & 0xff00) + (((color) & 0xff00) << 8) + ((color) << 24)));
}

static int mem32_word_copy_mono(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h, gx_color_index zero, gx_color_index one)
{
    return mem_true32_copy_mono(dev, base, sourcex, sraster, id, x, y, w, h, (((zero) >> 24) + (((zero) >> 8) & 0xff00) + (((zero) & 0xff00) << 8) + ((zero) << 24)), (((one) >> 24) + (((one) >> 8) & 0xff00) + (((one) & 0xff00) << 8) + ((one) << 24)));
}

static int mem32_word_copy_color(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h)
{
    byte *row;
    uint raster;
    if ((x | y) < 0) {
    ...
    bytes_copy_rectangle(row + (x << 2), raster, base + (sourcex << 2), sraster, w << 2, h);
