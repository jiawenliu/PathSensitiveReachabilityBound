...
static int specific_vm_op(os_ptr op, int (*opproc) (os_ptr), uint space)
{
...
static int zglobalvmarray(os_ptr op)
{
    return specific_vm_op(op, zarray, avm_global);
}

static int zglobalvmdict(os_ptr op)
{
    return specific_vm_op(op, zdict, avm_global);
}

static int zglobalvmpackedarray(os_ptr op)
{
    return specific_vm_op(op, zpackedarray, avm_global);
}

static int zglobalvmstring(os_ptr op)
{
    return specific_vm_op(op, zstring, avm_global);
}

static int zlocalvmarray(os_ptr op)
{
    return specific_vm_op(op, zarray, avm_local);
}

static int zlocalvmdict(os_ptr op)
{
    return specific_vm_op(op, zdict, avm_local);
}

static int zlocalvmpackedarray(os_ptr op)
{
    return specific_vm_op(op, zpackedarray, avm_local);
}

static int zlocalvmstring(os_ptr op)
{
    return specific_vm_op(op, zstring, avm_local);
}

static int zsystemvmarray(os_ptr op)
{
    return specific_vm_op(op, zarray, avm_system);
}

static int zsystemvmdict(os_ptr op)
{
    return specific_vm_op(op, zdict, avm_system);
}

static int zsystemvmpackedarray(os_ptr op)
{
    return specific_vm_op(op, zpackedarray, avm_system);
}

static int zsystemvmstring(os_ptr op)
{
    return specific_vm_op(op, zstring, avm_system);
}

static int zsystemvmcheck(register os_ptr op)
{
    ((op)->value.boolval = (((avm_space) (((op)->tas.type_attrs) & (((1 << 2) - 1) << 2)) == avm_system ? ((bool) 1) : ((bool) 0))), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)));
    return 0;
}

const op_def *zsysvm_op_defs(void)
{
    static const op_def op_defs_[] = { {"1.globalvmarray", zglobalvmarray}, {"1.globalvmdict", zglobalvmdict}, {"1.globalvmpackedarray", zglobalvmpackedarray}, {"1.globalvmstring", zglobalvmstring}, {"1.localvmarray", zlocalvmarray}, {"1.localvmdict", zlocalvmdict}, {"1.localvmpackedarray", zlocalvmpackedarray}, {"1.localvmstring", zlocalvmstring}, {"1.systemvmarray", zsystemvmarray}, {"1.systemvmcheck", zsystemvmcheck}, {"1.systemvmdict", zsystemvmdict}, {"1.systemvmpackedarray", zsystemvmpackedarray}, {"1.systemvmstring", zsystemvmstring}, {(char *) 0, (op_proc_p) 0} };
    return op_defs_;
}
