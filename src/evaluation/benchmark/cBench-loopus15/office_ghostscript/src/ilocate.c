...
chunk_t *gc_locate(const void *ptr, gc_state_t * gcst)
{
	...
	return gcst->loc.cp;
    mem = gcst->loc.memory;
    if (gcst->spaces.named.local != gcst->spaces.named.global) {
	gcst->loc.memory = (mem->space == avm_local ? gcst->spaces.named.global : gcst->spaces.named.local);
	gcst->loc.cp = 0;
	if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t) ((const byte *) (ptr)) >= (ptr_ord_t) (((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t) ((const byte *) (ptr)) < (ptr_ord_t) (((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t) ((const byte *) (ptr)) >= (ptr_ord_t) (((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t) ((const byte *) (ptr)) < (ptr_ord_t) (((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
	    return gcst->loc.cp;
    ...
    if (mem != gcst->spaces.named.system) {
	gcst->loc.memory = gcst->spaces.named.system;
	gcst->loc.cp = 0;
	if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t) ((const byte *) (ptr)) >= (ptr_ord_t) (((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t) ((const byte *) (ptr)) < (ptr_ord_t) (((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t) ((const byte *) (ptr)) >= (ptr_ord_t) (((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t) ((const byte *) (ptr)) < (ptr_ord_t) (((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
	    return gcst->loc.cp;
    }
    gcst->loc.memory = (mem == gcst->spaces.named.system || mem->space == avm_global ? gcst->spaces.named.global : gcst->spaces.named.local);
    for (;;) {
...
void ialloc_validate_spaces(const gs_dual_memory_t * dmem)
{
} void ialloc_validate_memory(const gs_ref_memory_t * mem, gc_state_t * gcst)
{
} void ialloc_validate_chunk(const chunk_t * cp, gc_state_t * gcst)
{
} void ialloc_validate_object(const obj_header_t * ptr, const chunk_t * cp, gc_state_t * gcst)
{
}
