...
void gp_init_console(void)
{
} void gp_console_puts(const char *str, uint size)
{
    fwrite(str, 1, size, gs_stdout);
} int gp_make_console_current(gx_device * dev)
{
    return 0;
}

int gp_make_graphics_current(gx_device * dev)
{
    return 0;
}
