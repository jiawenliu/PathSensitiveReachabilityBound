...
extern int mem_gray_strip_copy_rop(gx_device * dev, const byte * sdata, int sourcex, uint sraster, gx_bitmap_id id, const gx_color_index * scolors, const gx_strip_bitmap * textures, const gx_color_index * tcolors, int x, int y, int width, int height, int phase_x, int phase_y, gs_logical_operation_t lop);
static int mem_mapped4_copy_mono(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height, gx_color_index color0, gx_color_index color1);
static int mem_mapped4_copy_color(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height);
static int mem_mapped4_fill_rectangle(gx_device * dev, int x, int y, int width, int height, gx_color_index color);
const gx_device_memory mem_mapped4_device = { sizeof(gx_device_memory), 0, "image4", 0, 0, 0, 0, {(4 ? 3 : 0) + (0 ? 1 : 0), 4 + 0, (0 ? (1 << 0) - 1 : (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1)), (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1), (0 ? (1 << 0) - 1 : (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1)) + 1, (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1) + 1}
...
static const uint tile_patterns[16] = { (uint) ((uint) (0x00) * 0x01010101), (uint) ((uint) (0x11) * 0x01010101), (uint) ((uint) (0x22) * 0x01010101), (uint) ((uint) (0x33) * 0x01010101), (uint) ((uint) (0x44) * 0x01010101), (uint) ((uint) (0x55) * 0x01010101), (uint) ((uint) (0x66) * 0x01010101), (uint) ((uint) (0x77) * 0x01010101), (uint) ((uint) (0x88) * 0x01010101), (uint) ((uint) (0x99) * 0x01010101), (uint) ((uint) (0xaa) * 0x01010101), (uint) ((uint) (0xbb) * 0x01010101), (uint) ((uint) (0xcc) * 0x01010101), (uint) ((uint) (0xdd) * 0x01010101), (uint) ((uint) (0xee) * 0x01010101), (uint) ((uint) (0xff) * 0x01010101) };

static int mem_mapped4_fill_rectangle(gx_device * dev, int x, int y, int w, int h, gx_color_index color)
{
    if ((x | y) < 0) {
	if (x < 0)
	    w += x, x = 0;
    ...
    if (w <= 0 || h <= 0)
	return 0;
    bits_fill_rectangle(((((gx_device_memory *) dev))->line_ptrs[y]), x << 2, ((gx_device_memory *) dev)->raster, tile_patterns[color], w << 2, h);
    return 0;
}

static int mem_mapped4_copy_mono(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h, gx_color_index zero, gx_color_index one)
{
    const byte *line;
    int first_bit;
    ...
    dest = (byte *) (((((gx_device_memory *) dev))->line_ptrs[y]) + (((x) >> 1) & -(sizeof(byte) == 1 ? 1 : sizeof(byte) == sizeof(short) ? 2 : sizeof(byte) == sizeof(int) ? 4 : 4)));
    line = base + (sourcex >> 3);
...
static int mem_mapped4_copy_color(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h)
{
    int code;
    if ((x | y) < 0) {
	if (x < 0)
	...
	return 0;
    dev->width <<= 2;
    code = (*((&mem_mono_device)->std_procs.copy_mono)) (dev, base, sourcex << 2, sraster, id, x << 2, y, w << 2, h, (gx_color_index) 0, (gx_color_index) 1);
    dev->width >>= 2;
    return code;
}

static int mem4_word_copy_mono(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height, gx_color_index color0, gx_color_index color1);
static int mem4_word_copy_color(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height);
static int mem4_word_fill_rectangle(gx_device * dev, int x, int y, int width, int height, gx_color_index color);
const gx_device_memory mem_mapped4_word_device = { sizeof(gx_device_memory), 0, "image4w", 0, 0, 0, 0, {(4 ? 3 : 0) + (0 ? 1 : 0), 4 + 0, (0 ? (1 << 0) - 1 : (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1)), (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1), (0 ? (1 << 0) - 1 : (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1)) + 1, (4 >= 8 ? 255 : 4 == 4 ? 15 : 4 == 2 ? 3 : 4 == 1 ? 1 : (1 << 0) - 1) + 1}
, 0, 0, {(((0) * 72.0 + 0.5) - 0.5) / (72), (((0) * 72.0 + 0.5) - 0.5) / (72)}
, {0, 0, 0, 0}
, 0, {72, 72}
, {72, 72}
...
, {0, 0, 0, 0}
, 0, 0, 0, {gx_default_install, gx_default_begin_page, gx_default_end_page}
, {mem_open, mem_get_initial_matrix, gx_default_sync_output, gx_default_output_page, mem_close, mem_mapped_map_rgb_color, mem_mapped_map_color_rgb, mem4_word_fill_rectangle, gx_default_tile_rectangle, mem4_word_copy_mono, mem4_word_copy_color, gx_default_draw_line, mem_word_get_bits, gx_default_get_params, gx_default_put_params, gx_default_map_cmyk_color, gx_forward_get_xfont_procs, gx_forward_get_xfont_device, gx_default_map_rgb_alpha_color, gx_forward_get_page_device, gx_default_get_alpha_bits, gx_default_copy_alpha, gx_default_get_band, gx_default_copy_rop, gx_default_fill_path, gx_default_stroke_path, gx_default_fill_mask, gx_default_fill_trapezoid, gx_default_fill_parallelogram, gx_default_fill_triangle, gx_default_draw_thin_line, gx_default_begin_image, gx_default_image_data, gx_default_end_image, gx_default_strip_tile_rectangle, gx_no_strip_copy_rop, gx_default_get_clipping_box}
, 0, {(float) (1), (float) (0), (float) (0), (float) (1), (float) (0), (float) (0)}, 0, ((bool) 1), (byte *) 0, (byte **) 0, 0, {(byte *) 0, 0}, {((unsigned long) (-1))}, {0, 0}, 0, 0, 0, 0, 0, ((unsigned long) (-1)) };

static int mem4_word_fill_rectangle(gx_device * dev, int x, int y, int w, int h, gx_color_index color)
{
    byte *base;
    uint raster;
    if ((x | y) < 0) {
    ...
    bits_fill_rectangle(base, x << 2, raster, tile_patterns[color], w << 2, h);
    mem_swap_byte_rect(base, raster, x << 2, w << 2, h, ((bool) 1));
    return 0;
}

static int mem4_word_copy_mono(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h, gx_color_index zero, gx_color_index one)
{
    byte *row;
    uint raster;
    bool store;
    ...
    mem_mapped4_copy_mono(dev, base, sourcex, sraster, id, x, y, w, h, zero, one);
    mem_swap_byte_rect(row, raster, x << 2, w << 2, h, ((bool) 0));
    return 0;
}

static int mem4_word_copy_color(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h)
{
    int code;
    if ((x | y) < 0) {
	if (x < 0)
	...
	return 0;
    dev->width <<= 2;
    code = (*((&mem_mono_word_device)->std_procs.copy_mono)) (dev, base, sourcex << 2, sraster, id, x << 2, y, w << 2, h, (gx_color_index) 0, (gx_color_index) 1);
    dev->width >>= 2;
    return code;
}
