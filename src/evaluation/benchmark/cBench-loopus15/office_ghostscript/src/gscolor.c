...
extern int gx_remap_DeviceGray(const gs_client_color *, const gs_color_space *, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
extern int gx_concretize_DeviceGray(const gs_client_color *, const gs_color_space *, frac *, const gs_imager_state *);
extern int gx_remap_concrete_DGray(const frac *, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
extern int gx_remap_DeviceRGB(const gs_client_color *, const gs_color_space *, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
extern int gx_concretize_DeviceRGB(const gs_client_color *, const gs_color_space *, frac *, const gs_imager_state *);
extern int gx_remap_concrete_DRGB(const frac *, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
const gs_color_space_type gs_color_space_type_DeviceGray = { gs_color_space_index_DeviceGray, 1, ((bool) 1), gx_init_paint_1, gx_same_concrete_space, gx_concretize_DeviceGray, gx_remap_concrete_DGray, gx_remap_DeviceGray, gx_no_install_cspace, gx_no_adjust_cspace_count, gx_no_adjust_color_count, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs }, gs_color_space_type_DeviceRGB = {
gs_color_space_index_DeviceRGB, 3, ((bool) 1), gx_init_paint_3, gx_same_concrete_space, gx_concretize_DeviceRGB, gx_remap_concrete_DRGB, gx_remap_DeviceRGB, gx_no_install_cspace, gx_no_adjust_cspace_count, gx_no_adjust_color_count, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs};

static gs_ptr_type_t color_space_enum_ptrs(void *ptr, uint size, uint index, const void **pep);
static void color_space_reloc_ptrs(void *ptr, uint size, gc_state_t * gcst);
const gs_memory_struct_type_t st_color_space = { sizeof(gs_color_space), "gs_color_space", 0, 0, color_space_enum_ptrs, color_space_reloc_ptrs, 0 };

static gs_ptr_type_t client_color_enum_ptrs(void *vptr, uint size, uint index, const void **pep)
{
    switch (index) {
    default:
	return 0;
    case 0:
	do {
	    *pep = (const void *) (((gs_client_color *) vptr)->pattern);
	    return (&ptr_struct_procs);
	} while (0);
    }
}

static void client_color_reloc_ptrs(void *vptr, uint size, gc_state_t * gcst)
{;
    ((gs_client_color *) vptr)->pattern = gs_reloc_struct_ptr((const void *) ((const gs_client_color *) vptr)->pattern, gcst);
} const gs_memory_struct_type_t st_client_color = { sizeof(gs_client_color), "gs_client_color", 0, 0, client_color_enum_ptrs, client_color_reloc_ptrs, 0 };

const gs_color_space *gs_cs_static_DeviceGray;
static gs_gc_root_t cs_gray_root;
const gs_color_space *gs_cs_static_DeviceRGB;
static gs_gc_root_t cs_rgb_root;
const gs_color_space *gs_cs_static_DeviceCMYK = 0;
static gs_gc_root_t cs_cmyk_root;
void gs_gscolor_init(gs_memory_t * mem)
{ {
	gs_color_space *pcs = (gs_color_space *) (*(mem)->procs.alloc_struct) (mem, &st_color_space, "gs_cs_static_DeviceGray");
	pcs->type = &gs_color_space_type_DeviceGray;
	gs_cs_static_DeviceGray = pcs;
};
(*(mem)->procs.register_root) (mem, &cs_gray_root, (&ptr_struct_procs), (void **) &gs_cs_static_DeviceGray, "gs_cs_static_DeviceGray"); {
    gs_color_space *pcs = (gs_color_space *) (*(mem)->procs.alloc_struct) (mem, &st_color_space, "gs_cs_static_DeviceRGB");
    pcs->type = &gs_color_space_type_DeviceRGB;
    gs_cs_static_DeviceRGB = pcs;
};
(*(mem)->procs.register_root) (mem, &cs_rgb_root, (&ptr_struct_procs), (void **) &gs_cs_static_DeviceRGB, "gs_cs_static_DeviceRGB");
(*(mem)->procs.register_root) (mem, &cs_cmyk_root, (&ptr_struct_procs), (void **) &gs_cs_static_DeviceCMYK, "gs_cs_static_DeviceCMYK");
} const gs_color_space *gs_color_space_DeviceGray(void)
{
    return gs_cs_static_DeviceGray;
}

const gs_color_space *gs_color_space_DeviceRGB(void)
{
    return gs_cs_static_DeviceRGB;
}

const gs_color_space *gs_color_space_DeviceCMYK(void)
{
    return gs_cs_static_DeviceCMYK;
}

gs_color_space_index gs_color_space_get_index(const gs_color_space * pcs)
{
...
const gs_color_space *gs_color_space_indexed_base(const gs_color_space * pcs)
{
    return (const gs_color_space *) &pcs->params.indexed.base_space;
} void gx_init_paint_1(gs_client_color * pcc, const gs_color_space * pcs)
{
    pcc->paint.values[0] = 0.0;
} void gx_init_paint_3(gs_client_color * pcc, const gs_color_space * pcs)
{
    pcc->paint.values[2] = 0.0;
    pcc->paint.values[1] = 0.0;
    pcc->paint.values[0] = 0.0;
} void gx_init_paint_4(gs_client_color * pcc, const gs_color_space * pcs)
{
    pcc->paint.values[3] = 1.0;
    gx_init_paint_3(pcc, pcs);
} int gx_no_install_cspace(gs_color_space * pcs, gs_state * pgs)
{
    return 0;
}

void gx_no_adjust_cspace_count(const gs_color_space * pcs, gs_memory_t * mem, int delta)
{
} void gx_no_adjust_color_count(const gs_client_color * pcc, const gs_color_space * pcs, gs_memory_t * mem, int delta)
{
} static gs_ptr_type_t color_space_enum_ptrs(void *vptr, uint size, uint index, const void **pep)
{
    return (*((gs_color_space *) vptr)->type->enum_ptrs) (((gs_color_space *) vptr), size, index, pep);
}

static void color_space_reloc_ptrs(void *vptr, uint size, gc_state_t * gcst)
{ {
	(*((gs_color_space *) vptr)->type->reloc_ptrs) (((gs_color_space *) vptr), size, gcst);
...
float gs_currentgray(const gs_state * pgs)
{
	...
	return ((color_rgb_to_gray(((frac) (((pcc->paint.values[0]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[1]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[2]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), (const gs_imager_state *) pgs)) / ((float) ((frac) 0x7ff8)));
    case gs_color_space_index_DeviceCMYK:
	return ((color_cmyk_to_gray(((frac) (((pcc->paint.values[0]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[1]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[2]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[3]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), (const gs_imager_state *) pgs)) / ((float) ((frac) 0x7ff8)));
    default:
	return 0.0;
    }
}
...
int gs_currentrgbcolor(const gs_state * pgs, float pr3[3])
{
    const gs_client_color *pcc = pgs->ccolor;
    switch (pgs->color_space->type->index) {
    case gs_color_space_index_DeviceGray:
    ...
    case gs_color_space_index_DeviceCMYK:{
	    frac frgb[3];
	    color_cmyk_to_rgb(((frac) (((pcc->paint.values[0]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[1]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[2]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), ((frac) (((pcc->paint.values[3]) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))), (const gs_imager_state *) pgs, frgb);
	    pr3[0] = ((frgb[0]) / ((float) ((frac) 0x7ff8)));
	    pr3[1] = ((frgb[1]) / ((float) ((frac) 0x7ff8)));
	    pr3[2] = ((frgb[2]) / ((float) ((frac) 0x7ff8)));
	} break;
    default:
...
{
    pgs->alpha = (gx_color_value) ((alpha < 0.0 ? 0.0 : alpha > 1.0 ? 1.0 : alpha) * ((gx_color_value) ((1L << (sizeof(gx_color_value) * 8)) - 1)));
    (((pgs)->dev_color)->type = (&gx_dc_procs_none));
    return 0;
}

float gs_currentalpha(const gs_state * pgs)
{
    return (float) pgs->alpha / ((gx_color_value) ((1L << (sizeof(gx_color_value) * 8)) - 1));
}

int gs_setnullcolor(gs_state * pgs)
{
    if (pgs->in_cachedevice)
	return ((-21));
    gs_setgray(pgs, 0.0);
    ((pgs->dev_color)->type = (&gx_dc_procs_null));
    return 0;
}

int gs_settransfer(gs_state * pgs, gs_mapping_proc tproc)
{
    return gs_settransfer_remap(pgs, tproc, ((bool) 1));
}

int gs_settransfer_remap(gs_state * pgs, gs_mapping_proc tproc, bool remap)
{
    gx_transfer_colored *ptran = &pgs->set_transfer.colored;
    do {
	if ((ptran->red) != 0 && !((ptran->red)->rc.ref_count += -1)) {
	    (*(ptran->red)->rc.free) ((ptran->red)->rc.memory, (void *) (ptran->red), "gs_settransfer");
	    (ptran->red) = 0;
	}
    } while (0);
    do {
	if ((ptran->green) != 0 && !((ptran->green)->rc.ref_count += -1)) {
	    (*(ptran->green)->rc.free) ((ptran->green)->rc.memory, (void *) (ptran->green), "gs_settransfer");
	    (ptran->green) = 0;
	}
    } while (0);
    do {
	if ((ptran->blue) != 0 && !((ptran->blue)->rc.ref_count += -1)) {
	    (*(ptran->blue)->rc.free) ((ptran->blue)->rc.memory, (void *) (ptran->blue), "gs_settransfer");
	    (ptran->blue) = 0;
	}
    } while (0);
    do {
	if ((ptran->gray) == 0 || (ptran->gray)->rc.ref_count > 1 || (ptran->gray)->rc.memory != (pgs->memory)) {
	    gx_transfer_map *new;
	    do {
		if (((new) = (gx_transfer_map *) (*(pgs->memory)->procs.alloc_struct) (pgs->memory, &st_transfer_map, "gs_settransfer")) == 0) {
		    goto fail;
		} else {
		    (new)->rc.ref_count = 1;
  ...
  fail:do {
	if ((ptran->red) != 0)
	    (ptran->red)->rc.ref_count++;
    } while (0);
    do {
	if ((ptran->green) != 0)
	    (ptran->green)->rc.ref_count++;
    } while (0);
    do {
	if ((ptran->blue) != 0)
	    (ptran->blue)->rc.ref_count++;
    } while (0);
    return ((-25));
}

gs_mapping_proc gs_currenttransfer(const gs_state * pgs)
{
...
void gx_set_device_color_1(gs_state * pgs)
{
    ...
    pcc->pattern = 0;
    pgs->color_space->type = &gs_color_space_type_DeviceGray;
    ((pdc)->colors.pure = (1), (pdc)->type = (&gx_dc_procs_pure));
    pgs->log_op = (rop3_default | (((bool) 0) ? 0x100 : 0) | (((bool) 0) ? 0x200 : 0) | (0 << 10));
} void load_transfer_map(gs_state * pgs, gx_transfer_map * pmap, floatp min_value)
{
    ...
    int i;
    for (i = 0; i < (1 << 8); i++) {
	float fval = (*proc) ((float) i / ((1 << 8) - 1), pmap);
	values[i] = (fval < min_value ? fmin : fval >= 1.0 ? ((frac) 0x7ff8) : ((frac) (((fval) + 0.5 / ((float) ((frac) 0x7ff8))) * ((float) ((frac) 0x7ff8)))));
}}
