...
void gc_strings_set_marks(chunk_t * cp, bool mark)
{
    if (cp->smark != 0) {
	do {
	} while (0);
	...
	if (mark)
	    gc_mark_string(cp->sbase, cp->climit - cp->sbase, ((bool) 1), cp);
    }
}

typedef string_mark_unit bword;
static bool gc_mark_string(const byte * ptr, uint size, bool set, const chunk_t * cp)
{
...
bool gc_string_mark(const byte * ptr, uint size, bool set, gc_state_t * gcst)
{
    const chunk_t *cp;
    bool marks;
    if (size == 0)
...
void gc_strings_clear_reloc(chunk_t * cp)
{
    if (cp->sreloc != 0) {
...
static const byte count_zero_bits_table[256] = { 8, 8 - 1, 8 - 1, 8 - 2, 8 - 1, 8 - 1 - 1, 8 - 1 - 1, 8 - 1 - 2, 8 - 1, 8 - 1 - 1, 8 - 1 - 1, 8 - 1 - 2, 8 - 2, 8 - 2 - 1, 8 - 2 - 1, 8 - 2 - 2, 8 - 1, 8 - 1 - 1, 8 - 1 - 1, 8 - 1 - 2, 8 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 2, 8 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 2, 8 - 1 - 2, 8 - 1 - 2 - 1, 8 - 1 - 2 - 1, 8 - 1 - 2 - 2, 8 - 1, 8 - 1 - 1, 8 - 1 - 1, 8 - 1 - 2, 8 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 2, 8 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 1, 8 - 1 - 1 - 2, 8 - 1 - 2, 8 - 1 - 2 - 1, 8 - 1 - 2 - 1, 8 - 1 - 2 - 2, 8 - 2, 8 - 2 - 1, 8 - 2 - 1, 8 - 2 - 2, 8 - 2 - 1, 8 - 2 - 1 - 1, 8 - 2 - 1 - 1, 8 - 2 - 1 - 2, 8 - 2 - 1, 8 - 2 - 1 - 1, 8 - 2 - 1 - 1, 8 - 2 - 1 - 2, 8 - 2 - 2, 8 - 2 - 2 - 1, 8 - 2 - 2 - 1, 8 - 2 - 2 - 2, 7, 7 - 1, 7 - 1, 7 - 2, 7 - 1, 7 - 1 - 1, 7 - 1 - 1, 7 - 1 - 2, 7 - 1, 7 - 1 - 1, 7 - 1 - 1, 7 - 1 - 2, 7 - 2, 7 - 2 - 1, 7 - 2 - 1, 7 - 2 - 2, 7 - 1, 7 - 1 - 1, 7 - 1 - 1, 7 - 1 - 2, 7 - 1 - 1, 7 - 1 - 1 - 1, 7 
 2 - 2 - 1, 7 - 2 - 2 - 1, 7 - 2 - 2 - 2, 6, 6 - 1, 6 - 1, 6 - 2, 6 - 1, 6 - 1 - 1, 6 - 1 - 1, 6 - 1 - 2, 6 - 1, 6 - 1 - 1, 6 - 1 - 1, 6 - 1 - 2, 6 - 2, 6 - 2 - 1, 6 - 2 - 1, 6 - 2 - 2, 6 - 1, 6 - 1 - 1, 6 - 1 - 1, 6 - 1 - 2, 6 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 2, 6 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 2, 6 - 1 - 2, 6 - 1 - 2 - 1, 6 - 1 - 2 - 1, 6 - 1 - 2 - 2, 6 - 1, 6 - 1 - 1, 6 - 1 - 1, 6 - 1 - 2, 6 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 2, 6 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 1, 6 - 1 - 1 - 2, 6 - 1 - 2, 6 - 1 - 2 - 1, 6 - 1 - 2 - 1, 6 - 1 - 2 - 2, 6 - 2, 6 - 2 - 1, 6 - 2 - 1, 6 - 2 - 2, 6 - 2 - 1, 6 - 2 - 1 - 1, 6 - 2 - 1 - 1, 6 - 2 - 1 - 2, 6 - 2 - 1, 6 - 2 - 1 - 1, 6 - 2 - 1 - 1, 6 - 2 - 1 - 2, 6 - 2 - 2, 6 - 2 - 2 - 1, 6 - 2 - 2 - 1, 6 - 2 - 2 - 2 };

void gc_strings_set_reloc(chunk_t * cp)
{
    if (cp->sreloc != 0 && cp->smark != 0) {
	byte *bot = cp->ctop;
	byte *top = cp->climit;
	uint count = (top - bot + ((1 << (2 + 4)) - 1)) >> (2 + 4);
	string_reloc_offset *relp = cp->sreloc + (cp->smark_size >> ((2 + 4) - 3));
	register byte *bitp = cp->smark + cp->smark_size;
	register string_reloc_offset reloc = 0;
	while (count--) {
	    bitp -= (1 << (2 + 4)) / 8;
	    reloc += (1 << (2 + 4)) - (uint) (count_zero_bits_table[bitp[0]]);
...
void gs_reloc_string(gs_string * sptr, gc_state_t * gcst)
{
    byte *ptr;
    const chunk_t *cp;
    uint offset;
...
void gs_reloc_const_string(gs_const_string * sptr, gc_state_t * gcst)
{
    gs_reloc_string((gs_string *) sptr, gcst);
} void gc_strings_compact(chunk_t * cp)
{
    if (cp->smark != 0) {
	byte *hi = cp->climit;
	byte *lo = cp->ctop;
