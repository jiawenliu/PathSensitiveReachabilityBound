...
bool gp_file_name_is_absolute(const char *fname, unsigned len)
{
    while (len && *fname == '.')
	++fname, --len;
    return (len && *fname == '/');
...
const char *gp_file_name_concat_string(const char *prefix, unsigned plen, const char *fname, unsigned len)
{
