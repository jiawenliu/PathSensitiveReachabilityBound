...
gx_io_device gs_iodev_pipe = { "%pipe%", "FileSystem", {iodev_no_init, iodev_no_open_device, ((void *) 0), pipe_fopen, pipe_fclose, iodev_no_delete_file, iodev_no_rename_file, iodev_no_file_status, iodev_no_enumerate_files, ((void *) 0), ((void *) 0), iodev_no_get_params, iodev_no_put_params} };
