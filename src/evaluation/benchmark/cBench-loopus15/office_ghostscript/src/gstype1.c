...
static int gs_type1_charstring_interpret(gs_type1_state * pcis, const gs_const_string * str, int *pindex)
{
  ...
  top:for (;;) {
	...
	case cx_hstem:
	    ...
	    type1_do_hstem(pcis, cstack[0], cstack[1], &(pcis)->pis->ctm);
	    csp = cstack - 1;
	    goto top;
	case cx_vstem:
	    type1_apply_path_hints(pcis, ((bool) 0), pcis->path);
	    type1_do_vstem(pcis, cstack[0], cstack[1], &(pcis)->pis->ctm);
	    csp = cstack - 1;
	    goto top;
	case cx_vmoveto:
	    cstack[1] = cstack[0];
	    cstack[0] = 0;
	    do {
		s.p.y += (((cstack[1]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[1]) >> (12))) * (s.fc).yy.f + ((((int) (cstack[1]) & ((1 << 12) - 1)) * (s.fc).yy.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[1]) >> (12))) * (s.fc).yy.l + (s.fc).round) >> ((s.fc).shift)));
		if (s.fc.skewed)
		    s.p.x += (((cstack[1]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[1]) >> (12))) * (s.fc).yx.f + ((((int) (cstack[1]) & ((1 << 12) - 1)) * (s.fc).yx.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[1]) >> (12))) * (s.fc).yx.l + (s.fc).round) >> ((s.fc).shift)));
	    } while (0);
	  move:if ((pcis->hint_next != 0 || (((s.ppath)->state_flags & psf_is_drawing) != 0)) && pcis->flex_count == 8)
		type1_apply_path_hints(pcis, ((bool) 1), pcis->path);
	    code = gx_path_add_point(s.ppath, s.p.x, s.p.y);
	    goto cc;
	case cx_rlineto:
	    accum_xy_proc(&s, cstack[0], cstack[1]);
	  line:code = gx_path_add_line_notes(s.ppath, s.p.x, s.p.y, sn_none);
	  cc:if (code < 0)
		return code;
	  pp:do {
	    } while (0);
	...
	case cx_hlineto:
	    do {
		s.p.x += (((cstack[0]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[0]) >> (12))) * (s.fc).xx.f + ((((int) (cstack[0]) & ((1 << 12) - 1)) * (s.fc).xx.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[0]) >> (12))) * (s.fc).xx.l + (s.fc).round) >> ((s.fc).shift)));
		if (s.fc.skewed)
		    s.p.y += (((cstack[0]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[0]) >> (12))) * (s.fc).xy.f + ((((int) (cstack[0]) & ((1 << 12) - 1)) * (s.fc).xy.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[0]) >> (12))) * (s.fc).xy.l + (s.fc).round) >> ((s.fc).shift)));
	    } while (0);
	    cstack[1] = 0;
	    goto line;
	case cx_vlineto:
	    ...
	    goto line;
	case cx_rrcurveto:
	    code = gs_op1_rrcurveto(&s, cstack[0], cstack[1], cstack[2], cstack[3], cstack[4], cstack[5]);
	    goto cc;
	case cx_endchar:
	    if (pcis->seac_base >= 0) {
		...
		s.ppath->position.x = pcis->position.x = ftx;
		s.ppath->position.y = pcis->position.y = fty;
		pcis->os_count = 0;
		pcis->ips_count = 1;
	...
	case cx_vhcurveto:{
		...
		do {
		    s.p.y += (((cstack[0]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[0]) >> (12))) * (s.fc).yy.f + ((((int) (cstack[0]) & ((1 << 12) - 1)) * (s.fc).yy.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[0]) >> (12))) * (s.fc).yy.l + (s.fc).round) >> ((s.fc).shift)));
		    if (s.fc.skewed)
			s.p.x += (((cstack[0]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[0]) >> (12))) * (s.fc).yx.f + ((((int) (cstack[0]) & ((1 << 12) - 1)) * (s.fc).yx.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[0]) >> (12))) * (s.fc).yx.l + (s.fc).round) >> ((s.fc).shift)));
		} while (0);
		pt1.x = s.p.x + ax0, pt1.y = s.p.y + ay0;
		accum_xy_proc(&s, cstack[1], cstack[2]);
		pt2.x = s.p.x, pt2.y = s.p.y;
		do {
		    s.p.x += (((cstack[3]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[3]) >> (12))) * (s.fc).xx.f + ((((int) (cstack[3]) & ((1 << 12) - 1)) * (s.fc).xx.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[3]) >> (12))) * (s.fc).xx.l + (s.fc).round) >> ((s.fc).shift)));
		    if (s.fc.skewed)
			s.p.y += (((cstack[3]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[3]) >> (12))) * (s.fc).xy.f + ((((int) (cstack[3]) & ((1 << 12) - 1)) * (s.fc).xy.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[3]) >> (12))) * (s.fc).xy.l + (s.fc).round) >> ((s.fc).shift)));
		} while (0);
	...
	case cx_hvcurveto:{
		...
		pt2.x = s.p.x, pt2.y = s.p.y;
		do {
		    s.p.y += (((cstack[3]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[3]) >> (12))) * (s.fc).yy.f + ((((int) (cstack[3]) & ((1 << 12) - 1)) * (s.fc).yy.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[3]) >> (12))) * (s.fc).yy.l + (s.fc).round) >> ((s.fc).shift)));
		    if (s.fc.skewed)
			s.p.x += (((cstack[3]) + ((1L << 12) << (11 - 1))) & ((-(1L << 12) << 11) | ((1 << 12) - 1)) ? (((int) ((cstack[3]) >> (12))) * (s.fc).yx.f + ((((int) (cstack[3]) & ((1 << 12) - 1)) * (s.fc).yx.f + ((1L << 12) >> 1)) >> (12))) : ((((int) ((cstack[3]) >> (12))) * (s.fc).yx.l + (s.fc).round) >> ((s.fc).shift)));
		} while (0);
		code = gx_path_add_curve_notes(s.ppath, pt1.x, pt1.y, pt2.x, pt2.y, s.p.x, s.p.y, sn_none);
	    }
	    goto cc;
	...
	case c1_hsbw:
	  ...
	  rsbw:pcis->os_count = 0;
	    ipsp->ip = cip, ipsp->dstate = state;
	    pcis->ips_count = ipsp - &pcis->ipstack[0] + 1;
	    if (pcis->init_done < 0) {
		pcis->init_done = 0;
	    } else {
		accum_xy_proc(&s, pcis->lsb.x, pcis->lsb.y);
		pcis->position.x = s.p.x;
		pcis->position.y = s.p.y;
	    }
	    return 1;
	case cx_escape:
	    ...
	    case ce1_dotsection:
		pcis->dotsection_flag ^= (0 ^ (-1));
		csp = cstack - 1;
		goto top;
	    case ce1_vstem3:
		type1_apply_path_hints(pcis, ((bool) 0), pcis->path);
		if (!pcis->vstem3_set && pcis->fh.use_x_hints) {
		    type1_do_center_vstem(pcis, pcis->lsb.x + cstack[2], cstack[3], &(pcis)->pis->ctm);
		    s.p.x += pcis->vs_offset.x;
		    s.p.y += pcis->vs_offset.y;
		    pcis->vstem3_set = ((bool) 1);
		}
		type1_do_vstem(pcis, cstack[0], cstack[1], &(pcis)->pis->ctm);
		type1_do_vstem(pcis, cstack[2], cstack[3], &(pcis)->pis->ctm);
		type1_do_vstem(pcis, cstack[4], cstack[5], &(pcis)->pis->ctm);
		csp = cstack - 1;
		goto top;
	    case ce1_hstem3:
		type1_apply_path_hints(pcis, ((bool) 0), pcis->path);
		type1_do_hstem(pcis, cstack[0], cstack[1], &(pcis)->pis->ctm);
		type1_do_hstem(pcis, cstack[2], cstack[3], &(pcis)->pis->ctm);
		type1_do_hstem(pcis, cstack[4], cstack[5], &(pcis)->pis->ctm);
		csp = cstack - 1;
		goto top;
	    case ce1_seac:{
		    gs_const_string acstr;
		    pcis->seac_base = ((int) ((cstack[3]) >> (12)));
		    s.p.x = ftx, s.p.y = fty;
		    pcis->asb_diff = cstack[0] - pcis->lsb.x;
		    pcis->adxy.x = cstack[1];
		    pcis->adxy.y = cstack[2];
		    accum_xy_proc(&s, cstack[1], cstack[2]);
		    s.ppath->position.x = pcis->position.x = s.p.x;
		    s.ppath->position.y = pcis->position.y = s.p.y;
		    pcis->os_count = 0;
		    code = (*pdata->seac_proc) (pfont, ((int) ((cstack[4]) >> (12))), &acstr);
		    if (code != 0) {
			*pindex = ((int) ((cstack[4]) >> (12)));
			return code;
		    }
		    csp = cstack - 1;
		...
		goto rsbw;
	    case ce1_div:
		csp[-1] = ((fixed) (((float) csp[-1] / (float) *csp) * (float) (1 << 12)));
		--csp;
		goto pushed;
	    case ce1_undoc15:
		csp = cstack - 1;
	    ...
	    case ce1_callothersubr:{
		    ...
		    case 0:{
			    ...
			    csp[-3] = csp[-2];
			    csp -= 3;
			    gx_path_current_point(s.ppath, &ept);
			    gx_path_add_point(s.ppath, pcis->flex_points[0].x, pcis->flex_points[0].y);
			    s.ppath->state_flags = pcis->flex_path_state_flags;
			    hpt.x = pcis->flex_points[1].x - pcis->flex_points[4].x;
			    hpt.y = pcis->flex_points[1].y - pcis->flex_points[4].y;
			    do {
			    } while (0); {
				code = gx_path_add_curve_notes(s.ppath, pcis->flex_points[2].x, pcis->flex_points[2].y, pcis->flex_points[3].x, pcis->flex_points[3].y, pcis->flex_points[4].x, pcis->flex_points[4].y, sn_none);
				if (code < 0)
				    return code;
				code = gx_path_add_curve_notes(s.ppath, pcis->flex_points[5].x, pcis->flex_points[5].y, pcis->flex_points[6].x, pcis->flex_points[6].y, pcis->flex_points[7].x, pcis->flex_points[7].y, sn_none);
			    }
			}
			if (code < 0)
			    return code;
			...
			goto top;
		    case 1:
			gx_path_current_point(s.ppath, &pcis->flex_points[0]);
			pcis->flex_path_state_flags = s.ppath->state_flags;
			pcis->flex_count = 1;
			csp -= 2;
			goto top;
		    case 2:
			if (pcis->flex_count >= 8)
			    return ((-10));
			gx_path_current_point(s.ppath, &pcis->flex_points[pcis->flex_count++]);
			csp -= 2;
			goto top;
		    case 3:
			pcis->ignore_pops = 1;
			(type1_apply_path_hints(pcis, ((bool) 0), pcis->path), type1_replace_stem_hints(pcis));
			csp -= 2;
			goto top;
		    case 14:
			num_results = 1;
		      blend:{
			    int num_values = ((int) ((csp[-1]) >> (12)));
			    ...
			    for (j = 0; j < num_results; j++, base++, deltas += k1)
				for (i = 1; i <= k1; i++)
				    *base += deltas[i] * pdata->WeightVector.values[i];
			    csp = base - 1;
			}
		...
		}
		{
		    ...
		    int n;
		    if (scount < 1 || csp[-1] < 0 || csp[-1] > ((fixed) (scount - 1) << 12))
			return ((-10));
		    n = ((int) ((csp[-1]) >> (12)));
		...
		s.p.x = ftx, s.p.y = fty;
		cstack[0] += pcis->adxy.x;
		cstack[1] += pcis->adxy.y;
		accum_xy_proc(&s, cstack[0], cstack[1]);
		goto pp;
	    default:
		return ((-10));
...
void gs_gstype1_init(gs_memory_t * mem)
{
