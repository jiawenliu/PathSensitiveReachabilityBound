...
int gs_initmatrix(gs_state * pgs)
{
    ...
    (pgs->ctm_inverse_valid = ((bool) 0), pgs->char_tm_valid = ((bool) 0), ((pgs->ctm).txy_fixed_valid = (((imat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (imat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) && ((imat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (imat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? (((((imat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (imat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed) ((imat.tx) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).tx = (((pgs->ctm).tx_fixed) * (1.0 / (1 << 12))), 0)), ((((imat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (imat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed) ((imat.ty) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).ty = (((pgs->ctm).ty_fixed) * (1.0 / (1 << 12))), 0)), ((bool) 1)) : ((pgs->ctm).tx = (imat.tx), (pgs->ctm).ty = (imat.ty), ((bool) 0)))));
...
int gs_defaultmatrix(const gs_state * pgs, gs_matrix * pmat)
{
	...
	*pmat = pgs->ctm_default;
    ...
    pmat->tx += dev->Margins[0] * dev->HWResolution[0] / dev->MarginsHWResolution[0];
    pmat->ty += dev->Margins[1] * dev->HWResolution[1] / dev->MarginsHWResolution[1];
    return 0;
}

int gs_setdefaultmatrix(gs_state * pgs, const gs_matrix * pmat)
{
    if (pmat == ((void *) 0))
...
int gs_setcharmatrix(gs_state * pgs, const gs_matrix * pmat)
{
    gs_matrix cmat;
    int code = gs_matrix_multiply(pmat, &(*(const gs_matrix *) &(pgs)->ctm), &cmat);
    if (code < 0)
	return code;
    ((pgs->char_tm).txy_fixed_valid = (((cmat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) && ((cmat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? (((((cmat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->char_tm).tx_fixed = ((fixed) ((cmat.tx) * (float) (1 << 12))), 0) : ((-13))), ((pgs->char_tm).tx = (((pgs->char_tm).tx_fixed) * (1.0 / (1 << 12))), 0)), ((((cmat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->char_tm).ty_fixed = ((fixed) ((cmat.ty) * (float) (1 << 12))), 0) : ((-13))), ((pgs->char_tm).ty = (((pgs->char_tm).ty_fixed) * (1.0 / (1 << 12))), 0)), ((bool) 1)) : ((pgs->char_tm).tx = (cmat.tx), (pgs->char_tm).ty = (cmat.ty), ((bool) 0))));
    *(gs_matrix *) & (pgs)->char_tm = cmat;
    pgs->char_tm_valid = ((bool) 1);
    return 0;
}

int gs_currentcharmatrix(gs_state * pgs, gs_matrix * ptm, bool force)
{
...
{
    (pgs->ctm_inverse_valid = ((bool) 0), pgs->char_tm_valid = ((bool) 0), ((pgs->ctm).txy_fixed_valid = (((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) && ((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? (((((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed) ((pmat->tx) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).tx = (((pgs->ctm).tx_fixed) * (1.0 / (1 << 12))), 0)), ((((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed) ((pmat->ty) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).ty = (((pgs->ctm).ty_fixed) * (1.0 / (1 << 12))), 0)), ((bool) 1)) : ((pgs->ctm).tx = (pmat->tx), (pgs->ctm).ty = (pmat->ty), ((bool) 0)))));
    (*(gs_matrix *) & (pgs)->ctm = (*pmat));
    return 0;
}

int gs_imager_setmatrix(gs_imager_state * pis, const gs_matrix * pmat)
{
    ((pis->ctm).txy_fixed_valid = (((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) && ((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? (((((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pis->ctm).tx_fixed = ((fixed) ((pmat->tx) * (float) (1 << 12))), 0) : ((-13))), ((pis->ctm).tx = (((pis->ctm).tx_fixed) * (1.0 / (1 << 12))), 0)), ((((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pis->ctm).ty_fixed = ((fixed) ((pmat->ty) * (float) (1 << 12))), 0) : ((-13))), ((pis->ctm).ty = (((pis->ctm).ty_fixed) * (1.0 / (1 << 12))), 0)), ((bool) 1)) : ((pis->ctm).tx = (pmat->tx), (pis->ctm).ty = (pmat->ty), ((bool) 0))));
    (*(gs_matrix *) & (pis)->ctm = (*pmat));
    return 0;
}

int gs_settocharmatrix(gs_state * pgs)
{
    if (pgs->char_tm_valid) {
	pgs->ctm = pgs->char_tm;
...
int gs_translate(gs_state * pgs, floatp dx, floatp dy)
{
    ...
    pt.x += pgs->ctm.tx;
    pt.y += pgs->ctm.ty;
    (pgs->ctm_inverse_valid = ((bool) 0), pgs->char_tm_valid = ((bool) 0), ((pgs->ctm).txy_fixed_valid = (((pt.x) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pt.x) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) && ((pt.y) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pt.y) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? (((((pt.x) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pt.x) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed) ((pt.x) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).tx = (((pgs->ctm).tx_fixed) * (1.0 / (1 << 12))), 0)), ((((pt.y) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (pt.y) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed) ((pt.y) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).ty = (((pgs->ctm).ty_fixed) * (1.0 / (1 << 12))), 0)), ((bool) 1)) : ((pgs->ctm).tx = (pt.x), (pgs->ctm).ty = (pt.y), ((bool) 0)))));
    return 0;
}
...
{
    int code = gs_matrix_rotate(&(*(const gs_matrix *) &(pgs)->ctm), ang, &(*(gs_matrix *) & (pgs)->ctm));
    pgs->ctm_inverse_valid = ((bool) 0), pgs->char_tm_valid = ((bool) 0);
    return code;
}
...
int gs_concat(gs_state * pgs, const gs_matrix * pmat)
{
    ...
    if (code < 0)
	return code;
    (pgs->ctm_inverse_valid = ((bool) 0), pgs->char_tm_valid = ((bool) 0), ((pgs->ctm).txy_fixed_valid = (((cmat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) && ((cmat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? (((((cmat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed) ((cmat.tx) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).tx = (((pgs->ctm).tx_fixed) * (1.0 / (1 << 12))), 0)), ((((cmat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2)) && (cmat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 12)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed) ((cmat.ty) * (float) (1 << 12))), 0) : ((-13))), ((pgs->ctm).ty = (((pgs->ctm).ty_fixed) * (1.0 / (1 << 12))), 0)), ((bool) 1)) : ((pgs->ctm).tx = (cmat.tx), (pgs->ctm).ty = (cmat.ty), ((bool) 0)))));
...
{
    if (!(!((((&pgs->ctm)->xy) == 0.0 && ((&pgs->ctm)->yx) == 0.0) || (((&pgs->ctm)->xx) == 0.0 && ((&pgs->ctm)->yy) == 0.0)))) {
	return gs_distance_transform_inverse(dx, dy, &(*(const gs_matrix *) &(pgs)->ctm), pt);
    } else {
	if (!pgs->ctm_inverse_valid) {
	    int code = ctm_set_inverse(pgs);
	    if (code < 0)
...
int gs_imager_idtransform(const gs_imager_state * pis, floatp dx, floatp dy, gs_point * pt)
{
    return gs_distance_transform_inverse(dx, dy, &(*(const gs_matrix *) &(pis)->ctm), pt);
} int gx_translate_to_fixed(register gs_state * pgs, fixed px, fixed py)
{
    double fpx = ((px) * (1.0 / (1 << 12)));
    double fdx = fpx - pgs->ctm.tx;
    double fpy = ((py) * (1.0 / (1 << 12)));
    double fdy = fpy - pgs->ctm.ty;
    fixed dx, dy;
    int code;
    if (pgs->ctm.txy_fixed_valid) {
	dx = ((fixed) ((fdx) * (float) (1 << 12)));
	dy = ((fixed) ((fdy) * (float) (1 << 12)));
	code = gx_path_translate(pgs->path, dx, dy);
	if (code < 0)
	    return code;
	if (pgs->char_tm_valid && pgs->char_tm.txy_fixed_valid)
	    pgs->char_tm.tx_fixed += dx, pgs->char_tm.ty_fixed += dy;
    } else {
...
int gx_scale_char_matrix(register gs_state * pgs, int sx, int sy)
{
    if (sx != 1) {
	pgs->ctm.xx *= sx;
	pgs->ctm.yx *= sx;
...
int gx_matrix_to_fixed_coeff(const gs_matrix * pmat, register fixed_coeff * pfc, int max_bits)
{
    gs_matrix ctm;
    int scale = -10000;
    int expt, shift;
    ...
    if (((ctm.xx) == 0.0))
	pfc->xx.f = 0, pfc->xx.l = 0;
    else
	pfc->xx.f = ldexp(ctm.xx, 12), pfc->xx.l = (long) ldexp(ctm.xx, scale);
    if (((ctm.xy) == 0.0))
	pfc->xy.f = 0, pfc->xy.l = 0;
    else
	pfc->xy.f = ldexp(ctm.xy, 12), pfc->xy.l = (long) ldexp(ctm.xy, scale);
    if (((ctm.yx) == 0.0))
	pfc->yx.f = 0, pfc->yx.l = 0;
    else
	pfc->yx.f = ldexp(ctm.yx, 12), pfc->yx.l = (long) ldexp(ctm.yx, scale);
    if (((ctm.yy) == 0.0))
	pfc->yy.f = 0, pfc->yy.l = 0;
    else
	pfc->yy.f = ldexp(ctm.yy, 12), pfc->yy.l = (long) ldexp(ctm.yy, scale);
