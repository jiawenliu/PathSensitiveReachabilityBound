...
void gx_device_forward_fill_in_procs(register gx_device_forward * dev)
{
    gx_device_set_procs((gx_device *) dev);
    if (((dev)->std_procs.get_initial_matrix) == 0)
	((dev)->std_procs.get_initial_matrix = (gx_forward_get_initial_matrix));
    if (((dev)->std_procs.sync_output) == 0)
	((dev)->std_procs.sync_output = (gx_forward_sync_output));
    if (((dev)->std_procs.output_page) == 0)
	((dev)->std_procs.output_page = (gx_forward_output_page));
    if (((dev)->std_procs.map_rgb_color) == 0)
	((dev)->std_procs.map_rgb_color = (gx_forward_map_rgb_color));
    if (((dev)->std_procs.map_color_rgb) == 0)
	((dev)->std_procs.map_color_rgb = (gx_forward_map_color_rgb));
    if (((dev)->std_procs.get_bits) == 0)
	((dev)->std_procs.get_bits = (gx_forward_get_bits));
    if (((dev)->std_procs.get_params) == 0)
	((dev)->std_procs.get_params = (gx_forward_get_params));
    if (((dev)->std_procs.put_params) == 0)
	((dev)->std_procs.put_params = (gx_forward_put_params));
    if (((dev)->std_procs.map_cmyk_color) == 0)
	((dev)->std_procs.map_cmyk_color = (gx_forward_map_cmyk_color));
    if (((dev)->std_procs.get_xfont_procs) == 0)
	((dev)->std_procs.get_xfont_procs = (gx_forward_get_xfont_procs));
    if (((dev)->std_procs.get_xfont_device) == 0)
	((dev)->std_procs.get_xfont_device = (gx_forward_get_xfont_device));
    if (((dev)->std_procs.map_rgb_alpha_color) == 0)
	((dev)->std_procs.map_rgb_alpha_color = (gx_forward_map_rgb_alpha_color));
    if (((dev)->std_procs.get_page_device) == 0)
	((dev)->std_procs.get_page_device = (gx_forward_get_page_device));
    if (((dev)->std_procs.get_alpha_bits) == 0)
	((dev)->std_procs.get_alpha_bits = (gx_forward_get_alpha_bits));
    if (((dev)->std_procs.get_band) == 0)
	((dev)->std_procs.get_band = (gx_forward_get_band));
    if (((dev)->std_procs.copy_rop) == 0)
	((dev)->std_procs.copy_rop = (gx_forward_copy_rop_proc));
    if (((dev)->std_procs.fill_path) == 0)
	((dev)->std_procs.fill_path = (gx_forward_fill_path));
    if (((dev)->std_procs.stroke_path) == 0)
	((dev)->std_procs.stroke_path = (gx_forward_stroke_path));
    if (((dev)->std_procs.fill_mask) == 0)
	((dev)->std_procs.fill_mask = (gx_forward_fill_mask));
    if (((dev)->std_procs.fill_trapezoid) == 0)
	((dev)->std_procs.fill_trapezoid = (gx_forward_fill_trapezoid));
    if (((dev)->std_procs.fill_parallelogram) == 0)
	((dev)->std_procs.fill_parallelogram = (gx_forward_fill_parallelogram));
    if (((dev)->std_procs.fill_triangle) == 0)
	((dev)->std_procs.fill_triangle = (gx_forward_fill_triangle));
    if (((dev)->std_procs.draw_thin_line) == 0)
	((dev)->std_procs.draw_thin_line = (gx_forward_draw_thin_line));
    if (((dev)->std_procs.begin_image) == 0)
	((dev)->std_procs.begin_image = (gx_forward_begin_image));
    if (((dev)->std_procs.image_data) == 0)
	((dev)->std_procs.image_data = (gx_forward_image_data));
    if (((dev)->std_procs.end_image) == 0)
	((dev)->std_procs.end_image = (gx_forward_end_image));
    if (((dev)->std_procs.strip_copy_rop) == 0)
	((dev)->std_procs.strip_copy_rop = (gx_forward_strip_copy_rop_proc));
    if (((dev)->std_procs.get_clipping_box) == 0)
	((dev)->std_procs.get_clipping_box = (gx_forward_get_clipping_box));
    gx_device_fill_in_procs((gx_device *) dev);
}

void gx_device_forward_color_procs(gx_device_forward * dev)
{
    ((dev)->std_procs.map_rgb_color = (gx_forward_map_rgb_color));
    ((dev)->std_procs.map_color_rgb = (gx_forward_map_color_rgb));
    ((dev)->std_procs.map_cmyk_color = (gx_forward_map_cmyk_color));
...
} void gx_forward_get_initial_matrix(gx_device * dev, gs_matrix * pmat)
{
	...
	(*((tdev)->std_procs.get_initial_matrix)) (tdev, pmat);
}

int gx_forward_sync_output(gx_device * dev)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_sync_output(dev) : (*((tdev)->std_procs.sync_output)) (tdev));
}

int gx_forward_output_page(gx_device * dev, int num_copies, int flush)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_output_page(dev, num_copies, flush) : (*((tdev)->std_procs.output_page)) (tdev, num_copies, flush));
}

gx_color_index gx_forward_map_rgb_color(gx_device * dev, gx_color_value r, gx_color_value g, gx_color_value b)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_w_b_map_rgb_color(dev, r, g, b) : (*((tdev)->std_procs.map_rgb_color)) (tdev, r, g, b));
}

int gx_forward_map_color_rgb(gx_device * dev, gx_color_index color, gx_color_value prgb[3])
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_w_b_map_color_rgb(dev, color, prgb) : (*((tdev)->std_procs.map_color_rgb)) (tdev, color, prgb));
}

int gx_forward_tile_rectangle(gx_device * dev, const gx_tile_bitmap * tile, int x, int y, int w, int h, gx_color_index color0, gx_color_index color1, int px, int py)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
	...
	proc = ((tdev)->std_procs.tile_rectangle);
...
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_get_bits(dev, y, data, actual_data) : (*((tdev)->std_procs.get_bits)) (tdev, y, data, actual_data));
}

int gx_forward_get_params(gx_device * dev, gs_param_list * plist)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_get_params(dev, plist) : (*((tdev)->std_procs.get_params)) (tdev, plist));
}

int gx_forward_put_params(gx_device * dev, gs_param_list * plist)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_put_params(dev, plist) : (*((tdev)->std_procs.put_params)) (tdev, plist));
}

gx_color_index gx_forward_map_cmyk_color(gx_device * dev, gx_color_value c, gx_color_value m, gx_color_value y, gx_color_value k)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_map_cmyk_color(dev, c, m, y, k) : (*((tdev)->std_procs.map_cmyk_color)) (tdev, c, m, y, k));
}

gx_xfont_procs *gx_forward_get_xfont_procs(gx_device * dev)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_get_xfont_procs(dev) : (*((tdev)->std_procs.get_xfont_procs)) (tdev));
}

gx_device *gx_forward_get_xfont_device(gx_device * dev)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_get_xfont_device(dev) : (*((tdev)->std_procs.get_xfont_device)) (tdev));
}

gx_color_index gx_forward_map_rgb_alpha_color(gx_device * dev, gx_color_value r, gx_color_value g, gx_color_value b, gx_color_value alpha)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_map_rgb_alpha_color(dev, r, g, b, alpha) : (*((tdev)->std_procs.map_rgb_alpha_color)) (tdev, r, g, b, alpha));
}
...
gx_device *gx_forward_get_page_device(gx_device * dev)
{
    ...
    pdev = (*((tdev)->std_procs.get_page_device)) (tdev);
...
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_get_alpha_bits(dev, type) : (*((tdev)->std_procs.get_alpha_bits)) (tdev, type));
}

int gx_forward_get_band(gx_device * dev, int y, int *band_start)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    return (tdev == 0 ? gx_default_get_band(dev, y, band_start) : (*((tdev)->std_procs.get_band)) (tdev, y, band_start));
}
...
int gx_forward_stroke_path(gx_device * dev, const gs_imager_state * pis, gx_path * ppath, const gx_stroke_params * params, const gx_drawing_color * pdcolor, const gx_clip_path * pcpath)
{
	...
	proc = ((tdev)->std_procs.stroke_path);
    return (*proc) (tdev, pis, ppath, params, pdcolor, pcpath);
}

int gx_forward_fill_mask(gx_device * dev, const byte * data, int dx, int raster, gx_bitmap_id id, int x, int y, int w, int h, const gx_drawing_color * pdcolor, int depth, gs_logical_operation_t lop, const gx_clip_path * pcpath)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
	...
	proc = ((tdev)->std_procs.fill_mask);
    return (*proc) (dev, data, dx, raster, id, x, y, w, h, pdcolor, depth, lop, pcpath);
}
...
int gx_forward_fill_trapezoid(gx_device * dev, const gs_fixed_edge * left, const gs_fixed_edge * right, fixed ybot, fixed ytop, bool swap_axes, const gx_drawing_color * pdcolor, gs_logical_operation_t lop)
{
	...
	proc = ((tdev)->std_procs.fill_trapezoid);
...
int gx_forward_fill_parallelogram(gx_device * dev, fixed px, fixed py, fixed ax, fixed ay, fixed bx, fixed by, const gx_drawing_color * pdcolor, gs_logical_operation_t lop)
{
	...
	proc = ((tdev)->std_procs.fill_parallelogram);
...
int gx_forward_fill_triangle(gx_device * dev, fixed px, fixed py, fixed ax, fixed ay, fixed bx, fixed by, const gx_drawing_color * pdcolor, gs_logical_operation_t lop)
{
	...
	proc = ((tdev)->std_procs.fill_triangle);
    return (*proc) (tdev, px, py, ax, ay, bx, by, pdcolor, lop);
}
...
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    int (*proc) (gx_device * dev, fixed fx0, fixed fy0, fixed fx1, fixed fy1, const gx_drawing_color * pdcolor, gs_logical_operation_t lop);
    if (tdev == 0)
	tdev = dev, proc = gx_default_draw_thin_line;
    else
	proc = ((tdev)->std_procs.draw_thin_line);
...
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    int (*proc) (gx_device * dev, const gs_imager_state * pis, const gs_image_t * pim, gs_image_format_t format, const gs_int_rect * prect, const gx_drawing_color * pdcolor, const gx_clip_path * pcpath, gs_memory_t * memory, void **pinfo);
    if (tdev == 0)
	tdev = dev, proc = gx_default_begin_image;
    else
	proc = ((tdev)->std_procs.begin_image);
    return (*proc) (tdev, pis, pim, format, prect, pdcolor, pcpath, memory, pinfo);
}

int gx_forward_image_data(gx_device * dev, void *info, const byte ** planes, int data_x, uint raster, int height)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    int (*proc) (gx_device * dev, void *info, const byte ** planes, int data_x, uint raster, int height);
    if (tdev == 0)
	tdev = dev, proc = gx_default_image_data;
    else
	proc = ((tdev)->std_procs.image_data);
...
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
    int (*proc) (gx_device * dev, void *info, bool draw_last);
    if (tdev == 0)
	tdev = dev, proc = gx_default_end_image;
    else
	proc = ((tdev)->std_procs.end_image);
    return (*proc) (tdev, info, draw_last);
}

int gx_forward_strip_tile_rectangle(gx_device * dev, const gx_strip_bitmap * tiles, int x, int y, int w, int h, gx_color_index color0, gx_color_index color1, int px, int py)
{
    gx_device *tdev = ((gx_device_forward *) dev)->target;
	...
	proc = ((tdev)->std_procs.strip_tile_rectangle);
...
void gx_forward_get_clipping_box(gx_device * dev, gs_fixed_rect * pbox)
{
	...
	(*((tdev)->std_procs.get_clipping_box)) (dev, pbox);
}
...
static int null_draw_thin_line(gx_device * dev, fixed fx0, fixed fy0, fixed fx1, fixed fy1, const gx_drawing_color * pdcolor, gs_logical_operation_t lop);
...
gx_device_null gs_null_device = { sizeof(gx_device_null), 0, "null", 0, 0, 1, 0, {(1 == 32 ? 4 : 1 > 1 ? 3 : 1), ((1 > 1) & (1 < 8) ? 8 : 1), (1 >= 8 ? 255 : 1), (1 >= 8 ? 255 : 1 > 1 ? 1 : 0), (1 >= 8 ? 5 : 2), (1 >= 8 ? 5 : 1 > 1 ? 2 : 0)}
...
, {0, 0, 0, 0}
, 0, 0, 0, {gx_default_install, gx_default_begin_page, gx_default_end_page}
, {gx_default_open_device, gx_forward_get_initial_matrix, gx_default_sync_output, gx_default_output_page, gx_default_close_device, gx_forward_map_rgb_color, gx_forward_map_color_rgb, null_fill_rectangle, gx_default_tile_rectangle, null_copy_mono, null_copy_color, gx_default_draw_line, gx_default_get_bits, gx_forward_get_params, null_put_params, gx_forward_map_cmyk_color, gx_forward_get_xfont_procs, gx_forward_get_xfont_device, gx_forward_map_rgb_alpha_color, gx_page_device_get_page_device, gx_forward_get_alpha_bits, null_copy_alpha, gx_forward_get_band, null_copy_rop, null_fill_path, null_stroke_path, gx_default_fill_mask, null_fill_trapezoid, null_fill_parallelogram, null_fill_triangle, null_draw_thin_line, gx_default_begin_image, gx_default_image_data, gx_default_end_image, gx_default_strip_tile_rectangle, null_strip_copy_rop, gx_default_get_clipping_box}
, 0 };

static int null_fill_rectangle(gx_device * dev, int x, int y, int w, int h, gx_color_index color)
{
    return 0;
}

static int null_copy_mono(gx_device * dev, const byte * data, int dx, int raster, gx_bitmap_id id, int x, int y, int w, int h, gx_color_index zero, gx_color_index one)
{
    return 0;
}
...
static int null_put_params(gx_device * dev, gs_param_list * plist)
{
    ...
    int code;
    if (tdev != 0)
	return (*((tdev)->std_procs.put_params)) (tdev, plist);
