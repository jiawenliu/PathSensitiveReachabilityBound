...
static gx_color_index mem_true16_map_rgb_color(gx_device * dev, gx_color_value red, gx_color_value green, gx_color_value blue);
static int mem_true16_map_color_rgb(gx_device * dev, gx_color_index color, gx_color_value rgb[3]);
static int mem_true16_copy_mono(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height, gx_color_index color0, gx_color_index color1);
static int mem_true16_copy_color(gx_device * dev, const byte * data, int data_x, int raster, gx_bitmap_id id, int x, int y, int width, int height);
static int mem_true16_fill_rectangle(gx_device * dev, int x, int y, int width, int height, gx_color_index color);
const gx_device_memory mem_true16_device = { sizeof(gx_device_memory), 0, "image16", 0, 0, 0, 0, {(16 ? 3 : 0) + (0 ? 1 : 0), 16 + 0, (0 ? (1 << 0) - 1 : (16 >= 8 ? 255 : 16 == 4 ? 15 : 16 == 2 ? 3 : 16 == 1 ? 1 : (1 << 0) - 1)), (16 >= 8 ? 255 : 16 == 4 ? 15 : 16 == 2 ? 3 : 16 == 1 ? 1 : (1 << 0) - 1), (0 ? (1 << 0) - 1 : (16 >= 8 ? 255 : 16 == 4 ? 15 : 16 == 2 ? 3 : 16 == 1 ? 1 : (1 << 0) - 1)) + 1, (16 >= 8 ? 255 : 16 == 4 ? 15 : 16 == 2 ? 3 : 16 == 1 ? 1 : (1 << 0) - 1) + 1}
...
static gx_color_index mem_true16_map_rgb_color(gx_device * dev, gx_color_value r, gx_color_value g, gx_color_value b)
{
    return ((r >> ((sizeof(gx_color_value) * 8) - 5)) << 11) + ((g >> ((sizeof(gx_color_value) * 8) - 6)) << 5) + (b >> ((sizeof(gx_color_value) * 8) - 5));
}

static int mem_true16_map_color_rgb(gx_device * dev, gx_color_index color, gx_color_value prgb[3])
{
    ushort value = color >> 11;
    prgb[0] = ((value << 11) + (value << 6) + (value << 1) + (value >> 4)) >> (16 - (sizeof(gx_color_value) * 8));
    value = (color >> 6) & 0x7f;
    prgb[1] = ((value << 10) + (value << 4) + (value >> 2)) >> (16 - (sizeof(gx_color_value) * 8));
    value = color & 0x3f;
    prgb[2] = ((value << 11) + (value << 6) + (value << 1) + (value >> 4)) >> (16 - (sizeof(gx_color_value) * 8));
    return 0;
}

static int mem_true16_fill_rectangle(gx_device * dev, int x, int y, int w, int h, gx_color_index color)
{
...
static int mem_true16_copy_mono(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h, gx_color_index zero, gx_color_index one)
{
...
static int mem_true16_copy_color(gx_device * dev, const byte * base, int sourcex, int sraster, gx_bitmap_id id, int x, int y, int w, int h)
{
    if ((x | y) < 0) {
	if (x < 0)
	    w += x, sourcex -= x, x = 0;
    ...
    if (w <= 0 || h <= 0)
	return 0;
    bytes_copy_rectangle(((((gx_device_memory *) dev))->line_ptrs[y]) + ((x) << 1), (((gx_device_memory *) dev))->raster, base + ((sourcex) << 1), sraster, ((w) << 1), h);
    return 0;
}
