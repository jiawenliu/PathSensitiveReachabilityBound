...
int length;
{
	...
	bi_buf |= (value << bi_valid); {
	    (void) _IO_putc((char) ((bi_buf) & 0xff), zfile);
	    (void) _IO_putc((char) ((ush) (bi_buf) >> 8), zfile);
	};
...
int header;
{
    bi_windup();
    if (header) { {
	    (void) _IO_putc((char) (((ush) len) & 0xff), zfile);
	    (void) _IO_putc((char) ((ush) ((ush) len) >> 8), zfile);
    }; {
	(void) _IO_putc((char) (((ush) ~ len) & 0xff), zfile);
	(void) _IO_putc((char) ((ush) ((ush) ~ len) >> 8), zfile);
    };
