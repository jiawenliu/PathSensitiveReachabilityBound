...
int unzip(FILE * inFile, FILE * outFile)
{
    ...
    zipfd = fileno(inFile);
    inbuf = (byte *) (malloc(8192 + 4));
    outbuf = (byte *) (malloc(0x2000 + 1));
    outout = outbuf;
    if ((inbuf == ((void *) 0)) || (outbuf == ((void *) 0)) || (outout == ((void *) 0))) {
    ...
    outptr = outbuf;
    zipeof = 0;
    memset(outbuf, 0, 0x2000);
    lseek(zipfd, ftell(inFile), 0);
    if ((incnt = read(zipfd, (char *) inbuf, 8192)) <= 0) {
