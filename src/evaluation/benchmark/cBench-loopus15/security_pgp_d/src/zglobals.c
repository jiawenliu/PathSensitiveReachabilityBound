...
char *errors[] = { "", "Unexpected end of zip file", "Zip file structure invalid", "Out of memory", "Internal logic error", "Entry too big to split", "Invalid comment format", "", "Interrupted", "Temporary file failure", "Input file read failure", "Nothing to do!", "Missing or empty zip file", "Output file write failure", "Could not create output file", "Invalid command arguments", "", "File not found or no read permission", };
