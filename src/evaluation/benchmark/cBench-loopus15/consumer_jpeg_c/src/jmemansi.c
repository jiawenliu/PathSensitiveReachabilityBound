...
static void read_backing_store(j_common_ptr cinfo, backing_store_ptr info, void *buffer_address, long file_offset, long byte_count)
{
    ...
    if (((size_t) fread((void *) (buffer_address), (size_t) 1, (size_t) (byte_count), (info->temp_file))) != (size_t) byte_count)
...
} static void write_backing_store(j_common_ptr cinfo, backing_store_ptr info, void *buffer_address, long file_offset, long byte_count)
{
    if (fseek(info->temp_file, file_offset, 0))
	((cinfo)->err->msg_code = (JERR_TFILE_SEEK), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
    if (((size_t) fwrite((const void *) (buffer_address), (size_t) 1, (size_t) (byte_count), (info->temp_file))) != (size_t) byte_count)
