...
static int read_byte(bmp_source_ptr sinfo)
{
...
static JDIMENSION get_8bit_row(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
    ...
    source->source_row--;
    image_ptr = (*cinfo->mem->access_virt_sarray) ((j_common_ptr) cinfo, source->whole_image, source->source_row, (JDIMENSION) 1, 0);
    inptr = image_ptr[0];
...
static JDIMENSION preload_image(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
	...
	image_ptr = (*cinfo->mem->access_virt_sarray) ((j_common_ptr) cinfo, source->whole_image, row, (JDIMENSION) 1, 1);
	out_ptr = image_ptr[0];
...
static void start_input_bmp(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
	...
	((cinfo)->err->msg_code = (JERR_INPUT_EOF), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
    if (((unsigned int) ((int) (bmpfileheader[0])) + (((unsigned int) ((int) (bmpfileheader[0 + 1]))) << 8)) != 0x4D42)
	((cinfo)->err->msg_code = (JERR_BMP_NOT), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
    bfOffBits = (INT32) ((INT32) ((int) (bmpfileheader[10])) + (((INT32) ((int) (bmpfileheader[10 + 1]))) << 8) + (((INT32) ((int) (bmpfileheader[10 + 2]))) << 16) + (((INT32) ((int) (bmpfileheader[10 + 3]))) << 24));
    if (!(((size_t) fread((void *) (bmpinfoheader), (size_t) 1, (size_t) (4), (source->pub.input_file))) == ((size_t) (4))))
	((cinfo)->err->msg_code = (JERR_INPUT_EOF), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
    headerSize = (INT32) ((INT32) ((int) (bmpinfoheader[0])) + (((INT32) ((int) (bmpinfoheader[0 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[0 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[0 + 3]))) << 24));
    ...
    case 12:
	biWidth = (INT32) ((unsigned int) ((int) (bmpinfoheader[4])) + (((unsigned int) ((int) (bmpinfoheader[4 + 1]))) << 8));
	biHeight = (INT32) ((unsigned int) ((int) (bmpinfoheader[6])) + (((unsigned int) ((int) (bmpinfoheader[6 + 1]))) << 8));
	biPlanes = ((unsigned int) ((int) (bmpinfoheader[8])) + (((unsigned int) ((int) (bmpinfoheader[8 + 1]))) << 8));
	source->bits_per_pixel = (int) ((unsigned int) ((int) (bmpinfoheader[10])) + (((unsigned int) ((int) (bmpinfoheader[10 + 1]))) << 8));
	switch (source->bits_per_pixel) {
	case 8:
	    mapentrysize = 3;
	    ((cinfo)->err->msg_code = (JTRC_BMP_OS2_MAPPED), (cinfo)->err->msg_parm.i[0] = ((int) biWidth), (cinfo)->err->msg_parm.i[1] = ((int) biHeight), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
	    break;
	case 24:
	    ((cinfo)->err->msg_code = (JTRC_BMP_OS2), (cinfo)->err->msg_parm.i[0] = ((int) biWidth), (cinfo)->err->msg_parm.i[1] = ((int) biHeight), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
	    break;
	default:
	    ((cinfo)->err->msg_code = (JERR_BMP_BADDEPTH), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
	    break;
    ...
    case 40:
    case 64:
	biWidth = ((INT32) ((int) (bmpinfoheader[4])) + (((INT32) ((int) (bmpinfoheader[4 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[4 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[4 + 3]))) << 24));
	biHeight = ((INT32) ((int) (bmpinfoheader[8])) + (((INT32) ((int) (bmpinfoheader[8 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[8 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[8 + 3]))) << 24));
	biPlanes = ((unsigned int) ((int) (bmpinfoheader[12])) + (((unsigned int) ((int) (bmpinfoheader[12 + 1]))) << 8));
	source->bits_per_pixel = (int) ((unsigned int) ((int) (bmpinfoheader[14])) + (((unsigned int) ((int) (bmpinfoheader[14 + 1]))) << 8));
	biCompression = ((INT32) ((int) (bmpinfoheader[16])) + (((INT32) ((int) (bmpinfoheader[16 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[16 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[16 + 3]))) << 24));
	biXPelsPerMeter = ((INT32) ((int) (bmpinfoheader[24])) + (((INT32) ((int) (bmpinfoheader[24 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[24 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[24 + 3]))) << 24));
	biYPelsPerMeter = ((INT32) ((int) (bmpinfoheader[28])) + (((INT32) ((int) (bmpinfoheader[28 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[28 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[28 + 3]))) << 24));
	biClrUsed = ((INT32) ((int) (bmpinfoheader[32])) + (((INT32) ((int) (bmpinfoheader[32 + 1]))) << 8) + (((INT32) ((int) (bmpinfoheader[32 + 2]))) << 16) + (((INT32) ((int) (bmpinfoheader[32 + 3]))) << 24));
	switch (source->bits_per_pixel) {
	case 8:
	    mapentrysize = 4;
	    ((cinfo)->err->msg_code = (JTRC_BMP_MAPPED), (cinfo)->err->msg_parm.i[0] = ((int) biWidth), (cinfo)->err->msg_parm.i[1] = ((int) biHeight), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
	    break;
	case 24:
	    ((cinfo)->err->msg_code = (JTRC_BMP), (cinfo)->err->msg_parm.i[0] = ((int) biWidth), (cinfo)->err->msg_parm.i[1] = ((int) biHeight), (*(cinfo)->err->emit_message) ((j_common_ptr) (cinfo), (1)));
	    break;
	default:
	    ((cinfo)->err->msg_code = (JERR_BMP_BADDEPTH), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
	    break;
	...
	source->colormap = (*cinfo->mem->alloc_sarray) ((j_common_ptr) cinfo, 1, (JDIMENSION) biClrUsed, (JDIMENSION) 3);
    ...
    source->whole_image = (*cinfo->mem->request_virt_sarray) ((j_common_ptr) cinfo, 1, 0, row_width, (JDIMENSION) biHeight, (JDIMENSION) 1);
    source->pub.get_pixel_rows = preload_image;
    if (cinfo->progress != ((void *) 0)) {
	cd_progress_ptr progress = (cd_progress_ptr) cinfo->progress;
	progress->total_extra_passes++;
    }
    source->pub.buffer = (*cinfo->mem->alloc_sarray) ((j_common_ptr) cinfo, 1, (JDIMENSION) (biWidth * 3), (JDIMENSION) 1);
...
} cjpeg_source_ptr jinit_read_bmp(j_compress_ptr cinfo)
{
    ...
    source = (bmp_source_ptr) (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1, ((size_t) sizeof(bmp_source_struct)));
    source->cinfo = cinfo;
