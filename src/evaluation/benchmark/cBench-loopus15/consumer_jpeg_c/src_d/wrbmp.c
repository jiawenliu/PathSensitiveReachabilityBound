...
static void put_pixel_rows(j_decompress_ptr cinfo, djpeg_dest_ptr dinfo, JDIMENSION rows_supplied)
{
    ...
    int pad;
    image_ptr = (*cinfo->mem->access_virt_sarray) ((j_common_ptr) cinfo, dest->whole_image, dest->cur_output_row, (JDIMENSION) 1, 1);
    dest->cur_output_row++;
...
} static void write_bmp_header(j_decompress_ptr cinfo, bmp_dest_ptr dest)
{
	...
	(bmpinfoheader[24] = (char) (((INT32) (cinfo->X_density * 100)) & 0xFF), bmpinfoheader[24 + 1] = (char) ((((INT32) (cinfo->X_density * 100)) >> 8) & 0xFF), bmpinfoheader[24 + 2] = (char) ((((INT32) (cinfo->X_density * 100)) >> 16) & 0xFF), bmpinfoheader[24 + 3] = (char) ((((INT32) (cinfo->X_density * 100)) >> 24) & 0xFF));
	(bmpinfoheader[28] = (char) (((INT32) (cinfo->Y_density * 100)) & 0xFF), bmpinfoheader[28 + 1] = (char) ((((INT32) (cinfo->Y_density * 100)) >> 8) & 0xFF), bmpinfoheader[28 + 2] = (char) ((((INT32) (cinfo->Y_density * 100)) >> 16) & 0xFF), bmpinfoheader[28 + 3] = (char) ((((INT32) (cinfo->Y_density * 100)) >> 24) & 0xFF));
    }
...
static void finish_output_bmp(j_decompress_ptr cinfo, djpeg_dest_ptr dinfo)
{
	...
	image_ptr = (*cinfo->mem->access_virt_sarray) ((j_common_ptr) cinfo, dest->whole_image, row - 1, (JDIMENSION) 1, 0);
...
djpeg_dest_ptr jinit_write_bmp(j_decompress_ptr cinfo, boolean is_os2)
{
    bmp_dest_ptr dest;
    JDIMENSION row_width;
    dest = (bmp_dest_ptr) (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1, ((size_t) sizeof(bmp_dest_struct)));
    ...
    dest->whole_image = (*cinfo->mem->request_virt_sarray) ((j_common_ptr) cinfo, 1, 0, row_width, cinfo->output_height, (JDIMENSION) 1);
    dest->cur_output_row = 0;
    if (cinfo->progress != ((void *) 0)) {
	cd_progress_ptr progress = (cd_progress_ptr) cinfo->progress;
	progress->total_extra_passes++;
    }
    dest->pub.buffer = (*cinfo->mem->alloc_sarray) ((j_common_ptr) cinfo, 1, row_width, (JDIMENSION) 1);
