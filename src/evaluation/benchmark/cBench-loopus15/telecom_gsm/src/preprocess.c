...
void Gsm_Preprocess(struct gsm_state *S, word * s, word * so)
{
	...
	SO = ((*s) >> (3)) << 2;
	s++;
	((SO >= -0x4000) ? (void) (0) : __assert_fail("SO >= -0x4000", "preprocess.c", 64, __PRETTY_FUNCTION__));
	((SO <= 0x3FFC) ? (void) (0) : __assert_fail("SO <= 0x3FFC", "preprocess.c", 65, __PRETTY_FUNCTION__));
	s1 = SO - z1;
	z1 = SO;
	((s1 != ((-32767) - 1)) ? (void) (0) : __assert_fail("s1 != ((-32767)-1)", "preprocess.c", 81, __PRETTY_FUNCTION__));
	L_s2 = s1;
	L_s2 <<= 15;
	msp = ((L_z2) >> (15));
	lsp = L_z2 - ((longword) msp << 15);
	L_s2 += (((((longword) (lsp) * (longword) (32735) + 16384)) >> (15)));
	L_temp = (longword) msp *32735;
	L_z2 = ((L_temp) < 0 ? ((L_s2) >= 0 ? (L_temp) + (L_s2) : (utmp = (ulongword) - ((L_temp) + 1) + (ulongword) - ((L_s2) + 1)) >= (2147483647) ? ((-2147483647) - 1) : -(longword) utmp - 2) : ((L_s2) <= 0 ? (L_temp) + (L_s2) : (utmp = (ulongword) (L_temp) + (ulongword) (L_s2)) >= (2147483647) ? (2147483647) : utmp));
	L_temp = ((L_z2) < 0 ? ((16384) >= 0 ? (L_z2) + (16384) : (utmp = (ulongword) - ((L_z2) + 1) + (ulongword) - ((16384) + 1)) >= (2147483647) ? ((-2147483647) - 1) : -(longword) utmp - 2) : ((16384) <= 0 ? (L_z2) + (16384) : (utmp = (ulongword) (L_z2) + (ulongword) (16384)) >= (2147483647) ? (2147483647) : utmp));
	msp = (((((longword) (mp) * (longword) (-28180) + 16384)) >> (15)));
	mp = ((L_temp) >> (15));
