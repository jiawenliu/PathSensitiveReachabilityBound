...
{
    *c++ = ((0xD & 0xF) << 4) | ((source[0] >> 2) & 0xF);
    *c++ = ((source[0] & 0x3) << 6) | (source[1] & 0x3F);
    *c++ = ((source[2] & 0x1F) << 3) | ((source[3] >> 2) & 0x7);
    *c++ = ((source[3] & 0x3) << 6) | ((source[4] & 0xF) << 2) | ((source[5] >> 2) & 0x3);
    *c++ = ((source[5] & 0x3) << 6) | ((source[6] & 0x7) << 3) | (source[7] & 0x7);
    *c++ = (((source + 8)[0] & 0x7F) << 1) | (((source + 9)[0] >> 1) & 0x1);
    *c++ = (((source + 9)[0] & 0x1) << 7) | (((source + 10)[0] & 0x3) << 5) | (((source + 11)[0] >> 1) & 0x1F);
    *c++ = (((source + 11)[0] & 0x1) << 7) | (((source + 12)[0] & 0x7) << 4) | (((source + 12)[1] & 0x7) << 1) | (((source + 12)[2] >> 2) & 0x1);
    *c++ = (((source + 12)[2] & 0x3) << 6) | (((source + 12)[3] & 0x7) << 3) | ((source + 12)[4] & 0x7);
    *c++ = (((source + 12)[5] & 0x7) << 5) | (((source + 12)[6] & 0x7) << 2) | (((source + 12)[7] >> 1) & 0x3);
    *c++ = (((source + 12)[7] & 0x1) << 7) | (((source + 12)[8] & 0x7) << 4) | (((source + 12)[9] & 0x7) << 1) | (((source + 12)[10] >> 2) & 0x1);
    *c++ = (((source + 12)[10] & 0x3) << 6) | (((source + 12)[11] & 0x7) << 3) | ((source + 12)[12] & 0x7);
    *c++ = (((source + 25 - 1)[1] & 0x7F) << 1) | (((source + 26 - 1)[1] >> 1) & 0x1);
    *c++ = (((source + 26 - 1)[1] & 0x1) << 7) | (((source + 27 - 1)[1] & 0x3) << 5) | (((source + 28 - 1)[1] >> 1) & 0x1F);
    *c++ = (((source + 28 - 1)[1] & 0x1) << 7) | (((source + 29 - 13)[13] & 0x7) << 4) | (((source + 29 - 13)[14] & 0x7) << 1) | (((source + 29 - 13)[15] >> 2) & 0x1);
    *c++ = (((source + 29 - 13)[15] & 0x3) << 6) | (((source + 29 - 13)[16] & 0x7) << 3) | ((source + 29 - 13)[17] & 0x7);
    *c++ = (((source + 29 - 13)[18] & 0x7) << 5) | (((source + 29 - 13)[19] & 0x7) << 2) | (((source + 29 - 13)[20] >> 1) & 0x3);
    *c++ = (((source + 29 - 13)[20] & 0x1) << 7) | (((source + 29 - 13)[21] & 0x7) << 4) | (((source + 29 - 13)[22] & 0x7) << 1) | (((source + 29 - 13)[23] >> 2) & 0x1);
    *c++ = (((source + 29 - 13)[23] & 0x3) << 6) | (((source + 29 - 13)[24] & 0x7) << 3) | ((source + 29 - 13)[25] & 0x7);
    *c++ = (((source + 42 - 2)[2] & 0x7F) << 1) | (((source + 43 - 2)[2] >> 1) & 0x1);
    *c++ = (((source + 43 - 2)[2] & 0x1) << 7) | (((source + 44 - 2)[2] & 0x3) << 5) | (((source + 45 - 2)[2] >> 1) & 0x1F);
    *c++ = (((source + 45 - 2)[2] & 0x1) << 7) | (((source + 46 - 26)[26] & 0x7) << 4) | (((source + 46 - 26)[27] & 0x7) << 1) | (((source + 46 - 26)[28] >> 2) & 0x1);
    *c++ = (((source + 46 - 26)[28] & 0x3) << 6) | (((source + 46 - 26)[29] & 0x7) << 3) | ((source + 46 - 26)[30] & 0x7);
    *c++ = (((source + 46 - 26)[31] & 0x7) << 5) | (((source + 46 - 26)[32] & 0x7) << 2) | (((source + 46 - 26)[33] >> 1) & 0x3);
    *c++ = (((source + 46 - 26)[33] & 0x1) << 7) | (((source + 46 - 26)[34] & 0x7) << 4) | (((source + 46 - 26)[35] & 0x7) << 1) | (((source + 46 - 26)[36] >> 2) & 0x1);
    *c++ = (((source + 46 - 26)[36] & 0x3) << 6) | (((source + 46 - 26)[37] & 0x7) << 3) | ((source + 46 - 26)[38] & 0x7);
    *c++ = (((source + 59 - 3)[3] & 0x7F) << 1) | (((source + 60 - 3)[3] >> 1) & 0x1);
    *c++ = (((source + 60 - 3)[3] & 0x1) << 7) | (((source + 61 - 3)[3] & 0x3) << 5) | (((source + 62 - 3)[3] >> 1) & 0x1F);
    *c++ = (((source + 62 - 3)[3] & 0x1) << 7) | (((source + 63 - 39)[39] & 0x7) << 4) | (((source + 63 - 39)[40] & 0x7) << 1) | (((source + 63 - 39)[41] >> 2) & 0x1);
    *c++ = (((source + 63 - 39)[41] & 0x3) << 6) | (((source + 63 - 39)[42] & 0x7) << 3) | ((source + 63 - 39)[43] & 0x7);
    *c++ = (((source + 63 - 39)[44] & 0x7) << 5) | (((source + 63 - 39)[45] & 0x7) << 2) | (((source + 63 - 39)[46] >> 1) & 0x3);
    *c++ = (((source + 63 - 39)[46] & 0x1) << 7) | (((source + 63 - 39)[47] & 0x7) << 4) | (((source + 63 - 39)[48] & 0x7) << 1) | (((source + 63 - 39)[49] >> 2) & 0x1);
    *c++ = (((source + 63 - 39)[49] & 0x3) << 6) | (((source + 63 - 39)[50] & 0x7) << 3) | ((source + 63 - 39)[51] & 0x7);
}
