...
int alaw_output(gsm_signal * buf)
{
    int i;
    for (i = 0; i < 160; i++, buf++)
	if (fputc((s2a[((unsigned short) (*buf)) >> 4]), out) == (-1))
	    return -1;
    return 0;
}
