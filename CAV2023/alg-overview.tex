...
It requires computing our two quantities, the \emph{path reachability-bound}, $\inoutB(\rprog, \tpath, c)$ and the \emph{loop reachability-bound}, $\lpchB(l: \rprog, \tpath, c)$.
