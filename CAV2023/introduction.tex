...
The new algorithm is built over an abstract transition graph, and effectively combines amortized complexity analysis with loop summarization-based multipath refinement.
