The approach in this step is inspired mainly from the Algorithm.2 in~\cite{SinnZV14},
...
% (which we do not fully presented but can be found in the Definition~20 in~\cite{SinnZV17}), 
