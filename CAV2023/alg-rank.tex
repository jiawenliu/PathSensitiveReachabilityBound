...
%
  ...
  Additionally,
  we also compute the reset graph $\resetG(c)$ and the reset chain for higher precision. We omite the computation, which is mainly following the Definition~20 in~\cite{SinnZV17}.
