...
we first compute two refined abstract states for each loop w.r.t. a simple transition path inside it,
...
\footnote{$l' \in \rprog$: the $\in$ notation denotes
the program point $l'$ is a vertex on a path in $\rprog$.}
%
\[
  \begin{array}{l}
