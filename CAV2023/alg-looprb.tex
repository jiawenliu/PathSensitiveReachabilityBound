...
%
We also guarantee the soundness of $\lpchB(l: \rprog, \tpath)$ in \highlight{Appendix~\ref{apdx:looprb-sound}}.
...
%  as in the bottom part of Figure~\ref{fig:threeWhile-overview}(b), and still c
