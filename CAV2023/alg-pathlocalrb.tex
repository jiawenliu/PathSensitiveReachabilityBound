...
\end{equation}
\footnotetext{We use $\absevent \in \rprog$ to denote $\absevent$ is an edge on path $\rprog$.}
%
...
\end{itemize}
\end{defn}
Now we compute $BD(\rprog, c)$ recursively by interactively computing  $\varGD(\rprog, c)$  as follows.
