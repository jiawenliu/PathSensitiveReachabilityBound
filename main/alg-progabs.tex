...
Then, we compute the $\absflow(c) = \absflow'(c')$ for $c'$ as follows,
 ...
 \[
   ...
   We also show the soundness of the \emph{abstract event computation} as Theorem~\ref{lem:abscfg_sound} below with proof in Appendix~\ref{apdx:pathinsensitive_rb_soundness}.
