...
limitation case as well.
Specifically, if I wrote $\forall \trace_0 \in \tdom_0(c), \trace \in \inftdom, c, c' \in \cdom \st \config{c, \trace_0} \rightarrow^{*} \config{c', \trace} $
then the non-terminating case where
