...
% \\
For the same reason, the DC-based algorithm in \cite{SinnZV17}
is only able to
...
This bound is computed using the estimated ranking function for every loop and path, which benefits from the high efficiency and accuracy of \emph{amortized complexity analysis} methodology.
