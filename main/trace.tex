...
% $[]^{\infty}$.
% $\inftdom = \ftdom \cup \{[]^{\infty}\}$ 
from $\inftdom$, which is the set of all finite or infinite traces.
...
Given two traces $\trace_1 \in \inftdom, \trace_2 \in \ftdom$, the trace concatenation operator 
