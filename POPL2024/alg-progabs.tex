...
\paragraph{Syntax.}
We define the abstract program syntax and the transition relation based on graph paths as below. 
The syntax of the abstract program is combination of the execution paths with extra annotations and the logic transition relation is a logic formula over constraints.
\[
  \begin{array}{rll}
