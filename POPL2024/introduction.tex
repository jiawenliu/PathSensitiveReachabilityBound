...
In Section~\ref{sec:looprb}, we introduce the loop reachability-bound and give the computation algorithm, which is used in Section~\ref{sec:pathrb} to compute a more precise path reachability-bound.
...
The soundness proof of each algorithm are given in the Appendices }