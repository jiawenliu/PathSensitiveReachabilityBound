...
linear computation.
For the set of example programs that have loop of logarithm complexity in the ``representative'' benchmark set in Table~\ref{tb:effectiveness-eval} and Tab.~\ref{tb:effectiveness-eval}, we
